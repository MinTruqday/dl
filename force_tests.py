...
files = [
    "DocLibEmbed.ts", "DocLibField.ts", "DocLibIframeEmbed.ts", 
    "DocLibKanbanBoard.ts", "DocLibKeyboard.ts", "DocLibLetterhead.ts", 
    "DocLibMermaid.ts", "DocLibReadAloud.ts", "DocLibSmartArtPyramid.ts"
]
...
"""
    ...
    print(f"Generated test for {file}")
