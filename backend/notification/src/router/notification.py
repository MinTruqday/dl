...
async def get_notifications(
    ...
    return APIResponse(
        data=await NotificationManager.get_notifications(
...
async def mark_as_read(
    ...
    return APIResponse(
        data=await NotificationManager.mark_as_read(notif_id, str(current_user.id), db),
...
async def delete_notification(
    ...
    return APIResponse(
        data=await NotificationManager.delete_notification(
