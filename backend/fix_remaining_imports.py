    ...
    for f in files:
        if f.endswith('.py'):
            ...
            if f == 'main.py':
                ...
                new_content = new_content.replace('import editor as editor', 'import editor')
                new_content = new_content.replace('import editorjs as editorjs', 'import editorjs')
                new_content = new_content.replace('import latex as latex', 'import latex')
