...
@router.get("/bo-du-lieu/{dataset_id}")
...
@router.delete("/bo-du-lieu/{dataset_id}")
...
@router.post("/bo-du-lieu/{dataset_id}/mau")
...
@router.get("/bo-du-lieu/{dataset_id}/mau")
...
@router.delete("/bo-du-lieu/{dataset_id}/mau/{sample_id}")
