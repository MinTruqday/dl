...
class AgentOpsHarness:
    ...
    def record_tool_call(
        ...
        log_fn(
            ...
            f"duration_ms={duration_ms} success={success}"
    ...
    async def _flush_session(self, session_id: str):
        ...
        try:
            ...
            logger.info(f"AgentOps: trace flushed to DB | session={session_id}")
        except Exception as e:
            logger.error(f"AgentOps: failed to flush trace to DB: {e}")
