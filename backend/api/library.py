...
@router.post("/bookmarks/folders", response_model=APIResponse[Any])
...
@router.get("/bookmarks/folders", response_model=APIResponse[Any])
...
@router.put("/bookmarks/folders/{folder_id}", response_model=APIResponse[Any])
...
@router.delete("/bookmarks/folders/{folder_id}", response_model=APIResponse[Any])
