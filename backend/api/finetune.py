...
async def create_dataset(req: dict, current_user: UserInDB = Depends(get_current_user)):
    name = req.get("name")
    if not name:
...
async def list_datasets(current_user: UserInDB = Depends(get_current_user)):
...
async def get_dataset(dataset_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def delete_dataset(dataset_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def add_samples(dataset_id: str, req: dict, current_user: UserInDB = Depends(get_current_user)):
...
async def delete_sample(dataset_id: str, sample_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def import_from_feedback(current_user: UserInDB = Depends(get_current_user)):
...
async def import_from_documents(req: dict, current_user: UserInDB = Depends(get_current_user)):
...
async def create_job(req: dict, current_user: UserInDB = Depends(get_current_user)):
...
async def start_training(job_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def get_job(job_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def cancel_job(job_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def deploy_model(job_id: str, current_user: UserInDB = Depends(get_current_user)):
...
async def evaluate_model(job_id: str, req: dict, current_user: UserInDB = Depends(get_current_user)):
...
async def update_progress(req: dict):
