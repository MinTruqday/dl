...
@router.post("/documents/{document_id}/reviews", response_model=APIResponse[ReviewResponse])
...
@router.get("/documents/{document_id}/reviews", response_model=APIResponse[List[ReviewResponse]])
