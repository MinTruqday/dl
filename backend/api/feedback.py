...
@router.post("/report", response_model=APIResponse[Any])
...
@router.post("/documents/{document_id}/rate", response_model=APIResponse[Any])
...
@router.post("/documents/{document_id}/typo", response_model=APIResponse[Any])
...
@router.get("/documents/{document_id}/typo", response_model=APIResponse[Any])
