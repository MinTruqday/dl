<<<<<<< HEAD:backend/api/profile.py
from typing import Any, Optional
from core.response import APIResponse
=======
from typing import Any
from shared.core.response import APIResponse
>>>>>>> 17b94401979547a37304e908bbde87033ed3da2a:backend/microservices/profile/api/profile.py
...
async def update_settings(data: SettingsUpdate, current_user: UserInDB = Depends(get_current_user)):
    return APIResponse(data=await SettingService.update_settings(data.model_dump(exclude_unset=True), current_user), message="Lưu cài đặt thành công", status=200)
