...
class EmailService:
    ...
    async def send_reset_password_email(email: str, token: str, db=None):
        ...
        subject = "Password Reset Verification Code - DocLib"
        html_body = f'\n        <!DOCTYPE html>\n        <html>\n        <head>\n            <style>\n                .container {{\n                    font-family: Arial, sans-serif;\n                    max-width: 600px;\n                    margin: 0 auto;\n                    padding: 20px;\n                    border: 1px solid #e0e0e0;\n                    border-radius: 8px;\n                    background-color: #f9f9f9;\n                }}\n                .header {{\n                    text-align: center;\n                    margin-bottom: 20px;\n                }}\n                .header h2 {{\n                    color: #333333;\n                }}\n                .content {{\n                    background-color: #ffffff;\n                    padding: 20px;\n                    border-radius: 6px;\n                    color: #555555;\n                    line-height: 1.6;\n                }}\n                .token-container {{\n                    text-align: center;\n                    margin: 20px 0;\n                }}\n                .token {{\n                    display: inline-block;\n                    font-size: 28px;\n                    font-weight: bold;\n                    letter-spacing: 6px;\n                    padding: 12px 24px;\n                    background-color: #e3f2fd;\n                    color: #1976d2;\n                    border: 2px dashed #90caf9;\n                    border-radius: 6px;\n                    margin: 10px 0;\n                }}\n                .footer {{\n                    margin-top: 20px;\n                    font-size: 12px;\n                    color: #999999;\n                    text-align: center;\n                }}\n            </style>\n        </head>\n        <body>\n            <div class="container">\n                <div class="header">\n                    <h2>DocLib</h2>\n                </div>\n                <div class="content">\n                    <p>Hello,</p>\n                    <p>We received a request to reset the password for the account <strong>{email}</strong>.</p>\n                    <p>Your verification code is:</p>\n                    <div class="token-container">\n                        <span class="token">{token}</span>\n                    </div>\n                    <p><strong>Note:</strong> This code is only valid for <strong>1 minute</strong>. If you did not request this change, please ignore this email.</p>\n                    <p>Best regards,<br>DocLib Team.</p>\n                </div>\n                <div class="footer">\n                    <p>This email is sent automatically. Please do not reply.</p>\n                </div>\n            </div>\n        </body>\n        </html>\n        '
        logger.info(f"Sending recovery code to {email}")
        if not all(
            [smtp_host, smtp_port, smtp_user, smtp_pass, sender_email, sender_name]
        ):
            logger.error(f"Email configuration error when sending to {email}")
            raise Exception("Email service configuration is incomplete")
