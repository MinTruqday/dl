...
async def generate_flashcard(req: FlashcardRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi tạo flashcard")
...
async def summarize_text(req: SummarizeRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi tóm tắt văn bản")
...
"""
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi thực hiện kiểm tra đạo văn")
...
async def unified_action(req: ActionRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Lỗi khi thực hiện hành động {req.action}")
...
async def generate_mindmap(req: MindmapRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi tạo bản đồ tư duy")
...
async def suggest_citations(req: CitationRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi gợi ý trích dẫn")
...
async def transform_tone(req: ToneRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi biến đổi văn bản")
...
async def peer_review(req: ReviewRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi thẩm định nội dung")
...
async def multi_doc_synthesis(req: SynthesisRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi tổng hợp đa tài liệu")
...
async def create_social_post(req: PostRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi tạo bài đăng mạng xã hội")
...
async def create_social_story(req: StoryRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi tạo tin mạng xã hội")
...
async def suggest_engagement(req: EngagementRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Lỗi khi gợi ý tương tác")
