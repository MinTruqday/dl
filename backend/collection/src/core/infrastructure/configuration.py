...
class Settings(BaseModel):
    ...
    MAX_DOWNLOAD_SIZE_BYTES: int = int(os.getenv("MAX_DOWNLOAD_SIZE_BYTES", str(500 * 1024 * 1024)))
    PLATFORM_SYSTEM_ID: str = os.getenv("PLATFORM_SYSTEM_ID", "")
    COLLECTION_DB_NAME: str = os.getenv("COLLECTION_DB_NAME", "doclib_collection")
