...
class RequirementAIDraftInput(BaseModel):
    title: str = Field(min_length=2, max_length=300)
    type: str = Field(default="functional", max_length=80)
    ...
    business_rules: list[str] = Field(default_factory=list, max_length=50)
