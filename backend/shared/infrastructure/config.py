...
class Settings(BaseModel):
    ...
    INTELLIGENCE_URL: str = os.getenv("INTELLIGENCE_URL")
    SHARED_URL: Optional[str] = os.getenv("SHARED_URL")
    WORKSPACE_URL: str = os.getenv("WORKSPACE_URL")
    INGESTION_URL: str = os.getenv("INGESTION_URL")
    CONVERSATIONS_URL: str = os.getenv("CONVERSATIONS_URL")
    BILLING_URL: str = os.getenv("BILLING_URL")
    ALERTS_URL: str = os.getenv("ALERTS_URL")
    ADMINISTRATION_URL: str = os.getenv("ADMINISTRATION_URL")
    IDENTITY_URL: str = os.getenv("IDENTITY_URL")
    DOCUMENTS_URL: str = os.getenv("DOCUMENTS_URL")
    LIVE_EVENTS_URL: str = os.getenv("LIVE_EVENTS_URL")
