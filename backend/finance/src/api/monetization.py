...
from src.schemas.wallet import PlanCreate, TipRequest, DocumentPricingRequest, FlashSaleRequest
...
@router.get('/thong-ke/doanh-thu', response_model=APIResponse[Any])
