...
from src.schemas.management import CampaignRequest
...
@router.post("/api-key", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.post("/marketing/campaign", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.get("/settings", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.get("/collectors/stats", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.post("/collectors/trigger", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.post("/collectors/stop", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.get("/collectors/logs", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.get("/collectors/active-jobs", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.post("/users/{user_id}/shadowban", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.post("/users/{user_id}/kyc/{status}", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
...
@router.get("/storage/stats", response_model=APIResponse[Any], dependencies=[Depends(require_role([RoleEnum.ADMIN]))])
