...
class ChatRepository:
    ...
    async def insert_ai_message(cls, *args, **kwargs):
        return await mongo_client.insert_one("ai_messages", *args, **kwargs)

    @classmethod
    async def find_ai_message(cls, *args, **kwargs):
        return await mongo_client.find_one("ai_messages", *args, **kwargs)

    @classmethod
    async def update_ai_session(cls, *args, **kwargs):
        return await mongo_client.update_one("ai_sessions", *args, **kwargs)

    @classmethod
    async def delete_ai_session(cls, *args, **kwargs):
        return await mongo_client.delete_one("ai_sessions", *args, **kwargs)

    @classmethod
    async def insert_ai_session(cls, *args, **kwargs):
        return await mongo_client.insert_one("ai_sessions", *args, **kwargs)

    @classmethod
    async def find_ai_session(cls, *args, **kwargs):
        return await mongo_client.find_one("ai_sessions", *args, **kwargs)
