...
class FinetuneRepository:
    ...
    async def update_job(cls, *args, **kwargs):
        return await mongo_client.update_one("finetune_jobs", *args, **kwargs)

    @classmethod
    async def insert_job(cls, *args, **kwargs):
        return await mongo_client.insert_one("finetune_jobs", *args, **kwargs)

    @classmethod
    async def find_job(cls, *args, **kwargs):
        return await mongo_client.find_one("finetune_jobs", *args, **kwargs)

    @classmethod
    async def update_dataset(cls, *args, **kwargs):
        return await mongo_client.update_one("finetune_datasets", *args, **kwargs)

    @classmethod
    async def delete_dataset(cls, *args, **kwargs):
        return await mongo_client.delete_one("finetune_datasets", *args, **kwargs)

    @classmethod
    async def insert_dataset(cls, *args, **kwargs):
        return await mongo_client.insert_one("finetune_datasets", *args, **kwargs)

    @classmethod
    async def find_dataset(cls, *args, **kwargs):
        return await mongo_client.find_one("finetune_datasets", *args, **kwargs)
    ...
    async def delete_samples(cls, *args, **kwargs):
        return await mongo_client.delete_many("finetune_samples", *args, **kwargs)

    @classmethod
    async def count_samples(cls, *args, **kwargs):
        return await mongo_client.count_documents("finetune_samples", *args, **kwargs)

    @classmethod
    async def delete_sample(cls, *args, **kwargs):
        return await mongo_client.delete_one("finetune_samples", *args, **kwargs)
