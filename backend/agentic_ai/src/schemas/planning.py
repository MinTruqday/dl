...
class ExecutionPlan(BaseModel):
    reasoning: str = Field(description="<internal_thought>A step-by-step logical chain explaining why the task was broken down this way and how inter-dependencies form a Directed Acyclic Graph (DAG).</internal_thought>")
