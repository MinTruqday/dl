...
class PlanNode(BaseModel):
    ...
    agent: Literal["InterpreterAgent", "EngineAgent", "Action", "Knowledge", "Reasoning"] = Field(description="<critical_instructions>Exact registered execution agent name</critical_instructions>")
