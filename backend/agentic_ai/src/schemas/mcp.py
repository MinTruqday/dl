...
class RegisterServerRequest(BaseModel):
    ...
    auth_env: str | None = Field(default=None, max_length=128, pattern=r"^MCP_[A-Z0-9_]+$", description="<security_context>Environment variable containing a remote bearer token.</security_context>")
