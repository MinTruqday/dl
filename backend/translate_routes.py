...
path_translations = {
    ...
    "/by-email/{invitee_email}": "/email/{invitee_email}",
    "/by-email/{username}": "/email/{username}",
    "/by-slug/{slug}": "/ten-mien/{slug}",
    "/by-slug/{username}": "/ten-mien/{username}",
    "/trash": "/thung-rac",
    "/personal": "/ca-nhan",
    "/recent": "/gan-day",
    "/stats": "/thong-ke",
...
def translate_httpx_calls(content):
    ...
    full_path_replacements = {
        ...
        "/users/by-email/{invitee_email}": "/nguoi-dung/email/{invitee_email}",
        "/users/by-email/{email}": "/nguoi-dung/email/{email}",
        "/users/by-email/{username}": "/nguoi-dung/email/{username}",
        "/users/by-slug/{username}": "/nguoi-dung/ten-mien/{username}",
