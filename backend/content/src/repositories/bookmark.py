...
class BookmarkRepository:
    ...
    async def update_folder(cls, *args, **kwargs):
        return await cls._get_db()['bookmark_folders'].update_one(*args, **kwargs)

    @classmethod
    async def delete_folder(cls, *args, **kwargs):
        return await cls._get_db()['bookmark_folders'].delete_one(*args, **kwargs)

    @classmethod
    async def insert_folder(cls, *args, **kwargs):
        return await cls._get_db()['bookmark_folders'].insert_one(*args, **kwargs)
