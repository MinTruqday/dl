...
async def get_trending_documents(
    ...
    return APIResponse(
        data=await DocumentManager.get_trending_documents(limit),
...
async def smart_search(
    ...
    if not current_user:
        return APIResponse(
            data=await DocumentManager.get_text_search(query, limit),
...
async def get_trending_tags(
    ...
    return APIResponse(
        data=await DocumentManager.get_trending_tags(limit),
