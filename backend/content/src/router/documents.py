...
@router.get("/folders", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.post("/folders", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.delete("/folders/{folder_id}", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.get("/personal", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.get("/trash", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.post("/{document_id}/restore", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.post("/{document_id}/protect", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.get("/{document_id}/activity-log", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.post("/{document_id}/star", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.post("/{document_id}/transfer", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.put("/{document_id}/tags", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
...
@router.put("/{document_id}/schedule", response_model=APIResponse[Any], dependencies=[Depends(require_role(["author", "admin"]))])
