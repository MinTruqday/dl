...
from src.api.system_dependency import (
    get_current_user,
...
async def create_document(
    ...
    return APIResponse(
        data=await DocumentMetadata.create_document(doc_in, current_user),
...
async def update_document_content(
    ...
    return APIResponse(
        data=await DocumentMetadata.update_document_content(
...
async def update_document(
    ...
    return APIResponse(
        data=await DocumentMetadata.update_document(
...
async def list_documents(
    ...
    return APIResponse(
        data=await DocumentMetadata.list_documents(
...
async def get_folders(
    ...
    folders = await DocumentMetadata.get_folders(parent_id, current_user)
...
async def create_folder(
    ...
    folder_doc = await DocumentMetadata.create_folder(req.name, req.parent_id, current_user)
...
async def delete_folder(
    ...
    res = await DocumentMetadata.delete_folder(folder_id, current_user)
    return APIResponse(
...
async def get_my_documents(
    ...
    return APIResponse(
        data=await DocumentMetadata.get_my_documents(current_user, q, cursor, limit),
...
async def get_trash(current_user: CurrentUser = Depends(get_current_user)):
    return APIResponse(
        data=await DocumentMetadata.get_trash(current_user),
...
async def get_document_by_id(
    ...
    return APIResponse(
        data=await DocumentMetadata.get_document_by_id(
...
async def get_document_by_slug(
    ...
    return APIResponse(
        data=await DocumentMetadata.get_document_by_slug(slug, current_user),
...
async def get_document_preview(slug: str):
    return APIResponse(
        data=await DocumentMetadata.get_document_preview(slug),
...
async def soft_delete_document(
    ...
    return APIResponse(
        data=await DocumentMetadata.soft_delete_document(document_id, current_user),
...
async def restore_document(
    ...
    return APIResponse(
        data=await DocumentMetadata.restore_document(document_id, current_user),
...
async def set_document_password(
    ...
    return APIResponse(
        data=await DocumentMetadata.set_document_password(
...
async def get_document_audit_logs(
    ...
    return APIResponse(
        data=await DocumentMetadata.get_document_audit_logs(document_id, current_user),
...
async def toggle_star_document(
    ...
    res = await DocumentMetadata.toggle_star_document(document_id, current_user)
    return APIResponse(
        data=res,
...
async def transfer_document(
    ...
    res = await DocumentMetadata.transfer_document(document_id, new_owner_id, current_user)
    return APIResponse(
        data=res,
...
async def get_document_analytics(
    ...
    res = await DocumentMetadata.get_document_analytics(document_id, current_user)
    return APIResponse(
        data=res,
...
async def get_document_academic(
    ...
    res = await DocumentMetadata.get_document_academic(document_id, current_user)
    return APIResponse(
        data=res,
...
async def update_drm_settings(
    ...
    result = await DocumentMetadata.update_document(
        document_id,
        DocumentUpdate(
            drm_settings={
