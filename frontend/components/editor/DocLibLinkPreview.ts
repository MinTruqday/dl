  ...
  render() {
    ...
    if (!document.getElementById('doclib-link-preview-styles')) {
      ...
      style.innerHTML = `
        ...
        .doclib-link-title:empty::before { content: 'Enter page title'; color: #94a3b8; pointer-events: none; }
        ...
        .doclib-link-desc:empty::before { content: 'Enter page description'; color: #94a3b8; pointer-events: none; }
        .doclib-link-site { font-size: 0.8em; color: #64748b; font-weight: 500; outline: none; }
        .doclib-link-site:empty::before { content: 'Website Name'; color: #94a3b8; pointer-events: none; }
  ...
  private buildUI() {
    ...
    if (this.data.link) {
      ...
      img.addEventListener('click', (e) => {
          e.preventDefault();
          const newUrl = prompt('Enter cover image URL for this link card:', this.data.meta.image.url);
          if (newUrl !== null) {
      ...
      input.placeholder = 'Paste URL to create Bookmark';
