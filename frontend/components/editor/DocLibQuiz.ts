...
export default class DocLibQuiz implements BlockTool {
  ...
  private data: { question: string, answers: { text: string, isCorrect: boolean }[] };
  ...
  constructor({ api, data }: { api: API, data: any }) {
    ...
    this.data = {
      ...
      answers: (data.answers && data.answers.length > 0) ? data.answers : [
  ...
  render() {
    ...
    if (!document.getElementById('doclib-quiz-styles')) {
        ...
        style.innerHTML = `
            ...
            .doclib-quiz-question:empty::before { content: 'Nhập câu hỏi trắc nghiệm...'; color: #94a3b8; pointer-events: none; }
            ...
            .doclib-quiz-text:empty::before { content: 'Nhập đáp án...'; color: #94a3b8; pointer-events: none; }
  ...
  private buildUI() {
      ...
      this.data.answers.forEach((ans, i) => {
          ...
          radio.addEventListener('change', () => {
              ...
              ans.isCorrect = true;
              this.buildUI(); // re-render to update classes
          });
          ...
          rmBtn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>';
