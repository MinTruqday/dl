...
export default class DocLibAnchor implements BlockTune {
  ...
  render() {
    ...
    toggler.innerHTML = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="3"></circle><line x1="12" y1="22" x2="12" y2="8"></line><path d="M5 12H2a10 10 0 0 0 20 0h-3"></path></svg>';
    ...
    toggler.addEventListener('click', () => {
        if (this.currentAnchor) {
            ...
            this._data = blockContent || `block_${Math.floor(Math.random() * 1000)}`;
            toggler.classList.add(this.api.styles.settingsButtonActive);
        }
