...
function StudioContent() {
  ...
  return (
    <div className="flex-1 flex flex-col h-[calc(100vh-var(--navbar-height))] overflow-hidden bg-white selection:bg-black selection:text-white relative font-sans">
      ...
      >
        ...
        <ModalFooter className="flex gap-4">
          <button
            ...
            className="flex-1 h-12 text-[10px] font-bold uppercase tracking-widest border border-zinc-100 rounded-sm"
          >
            Bỏ qua
          </button>
          <button
            onClick={executeConfirm}
            className="flex-1 h-12 bg-black text-white text-[10px] font-bold uppercase tracking-widest rounded-sm transition-transform"
          >
            Xác nhận
          </button>
        </ModalFooter>
        ...
        <form onSubmit={(e) => { e.preventDefault(); addChapter(); }}>
          <ModalContent>
            <input
              ...
              placeholder=""
              className="w-full h-14 border border-zinc-100 px-5 font-bold text-xs focus:outline-none focus:border-black rounded-sm"
              autoFocus
            />
          </ModalContent>
          <ModalFooter className="flex gap-4">
      ...
      >
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full h-14 border border-zinc-100 px-6 text-sm font-bold rounded-sm outline-none focus:border-black transition-colors"
              />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">
        ...
        <ModalFooter className="flex gap-4">
          <button
            ...
            className="flex-1 h-14 text-[10px] font-bold uppercase tracking-widest border border-zinc-100 rounded-sm"
          >
            Hủy
          </button>
          <button
            ...
            className="flex-1 h-14 bg-black text-white text-[10px] font-bold uppercase tracking-widest rounded-sm flex items-center justify-center gap-2 transition-transform active:scale-95 disabled:opacity-50"
          >
            {requestingPayout ? (
      ...
      <div
        className="h-16 border-b border-zinc-100 px-8 flex items-center justify-between bg-white shrink-0 z-30 "
        style={{
          opacity: visible ? 1 : 0,
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="h-10 px-6 border border-zinc-200 text-[10px] font-bold uppercase tracking-widest disabled:opacity-50 flex items-center gap-2 rounded-sm"
            >
              {isSaving ? (
            ...
            <button
              ...
              className="h-10 px-8 bg-black text-white text-[10px] font-bold uppercase tracking-widest disabled:opacity-50 active:scale-95 rounded-sm"
            >
              Công bố tác phẩm
            </button>
          </div>
      ...
      >
        <nav className="w-16 border-r border-zinc-100 flex flex-col items-center py-8 gap-6 shrink-0 bg-white">
          {[
            ...
            <button
              ...
              className={`p-3 relative group rounded-sm ${
                viewMode === item.mode
                  ? "bg-black text-white"
                  : "text-zinc-300 "
              }`}
            ...
            >
              ...
              <div className="absolute left-full ml-4 px-3 py-1.5 bg-black text-white text-[9px] font-bold uppercase tracking-widest whitespace-nowrap opacity-0 pointer-events-none z-50 rounded-sm">
                {item.label}
              </div>
            </button>
          ))}
        ...
        <aside className="w-80 border-r border-zinc-100 flex flex-col shrink-0 bg-white animate-in slide-in-from-left ">
          {viewMode === "edit" ? (
            <>
              <div className="p-8 border-b border-zinc-100 bg-white/20">
                <div className="flex justify-between items-center mb-8">
                  ...
                  <button
                    ...
                    className="text-[10px] font-bold text-black flex items-center gap-2"
                  >
                ...
                <div className="space-y-2">
                  ...
                  selectedDocument.chapters.length === 0 ? (
                    ...
                    selectedDocument.chapters.map((ch: any, idx: number) => (
                      <div
                        key={ch.id || idx}
                        className="group flex items-center gap-4 p-4 border border-zinc-100 bg-white cursor-pointer rounded-sm"
                      >
                        <span className="text-[10px] font-bold text-zinc-200 w-4 transition-colors">
                          {idx + 1}
                        </span>
                        <span className="text-[11px] font-bold truncate flex-1 text-zinc-500 transition-colors tracking-tight">
                          {ch.title}
                        </span>
                        <div className="flex flex-col gap-1 opacity-0 ">
                          ...
                          >
                            <ArrowUp className="w-2.5 h-2.5 text-zinc-300 " />
                          </button>
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar p-8 space-y-8">
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {documents
                      .filter((d) => d._id !== selectedDocumentId)
                      .map((doc) => (
                        <button
                          key={doc._id}
                          onClick={() => setSelectedDocumentId(doc._id)}
                          className="w-full text-left p-5 border border-zinc-50 bg-white group rounded-sm"
                        >
                          <p className="text-[11px] font-bold text-zinc-400 truncate mb-2 transition-colors">
                            {doc.title}
                          </p>
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-1 h-1 rounded-sm ${doc.status === "published" ? "bg-black" : "bg-zinc-200"}`}
                            />
            ...
            <div className="p-8">
              <h3 className="text-[10px] font-bold text-black uppercase tracking-widest mb-8">
                Danh sách tác phẩm
              </h3>
              <div className="space-y-3">
                {documents.map((doc) => (
                  <button
                    key={doc._id}
                    onClick={() => setSelectedDocumentId(doc._id)}
                    className={`w-full text-left p-5 border flex flex-col gap-2 rounded-sm ${
                  ...
                  >
                    ...
                    <span className="text-[9px] font-bold opacity-40 uppercase tracking-widest italic">
                      {doc.status || "Bản nháp"}
                    </span>
                  </button>
                ))}
        ...
        <main className="flex-1 bg-white overflow-hidden relative">
                ...
                <div className="flex h-full">
                  {(["edit", "preview", "raw"] as const).map((m) => (
                    <button
                      ...
                      className={`px-8 h-full text-[9px] font-bold uppercase tracking-widest border-b-2 ${
                        editorMode === m
                ...
                <div className="max-w-4xl mx-auto animate-in slide-in-from-bottom-6 ">
                  {editorMode === "edit" ? (
                    ...
                    <div className="bg-white p-20 border border-zinc-100 rounded-sm">
                      <div
                        className="prose prose-zinc max-w-none font-sans text-lg leading-relaxed text-zinc-800"
          ...
          {viewMode === "stats" && (
            <div className="h-full overflow-y-auto p-16 animate-in fade-in no-scrollbar">
              <div className="max-w-5xl mx-auto space-y-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                    ...
                    {
                      label: "Mạng lưới độc giả",
                      val: stats?.followers_count || 0,
                      icon: Database,
                      unit: "Độc giả",
                    },
                    {
                    ...
                    <div
                      key={i}
                      className="bg-white p-12 border border-zinc-100 group rounded-sm"
                    >
                      <s.icon className="w-6 h-6 text-zinc-100 transition-colors mb-10" />
                      <h4 className="text-4xl font-bold tracking-tighter mb-2">
                        {s.val.toLocaleString()}{" "}
                        <span className="text-sm text-zinc-200">{s.unit}</span>
                      </h4>
                ...
                <div className="bg-white border border-zinc-100 rounded-sm">
                  <div className="p-10 border-b border-zinc-100 flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="h-10 px-6 bg-black text-white text-[10px] font-bold uppercase tracking-widest rounded-sm flex items-center gap-2"
                    >
                    ...
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y divide-zinc-50">
                        {(stats?.documents || []).map((doc: any) => (
                          ...
                          >
                            <td className="px-10 py-8 font-bold text-zinc-500 transition-colors text-sm uppercase">
                              {doc.title}
                            </td>
                            <td className="px-10 py-8 font-bold text-black">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex gap-0.5">
                                  {[1, 2, 3, 4, 5].map((star) => (
                                    <div
                                      key={star}
                                      className={`w-1.5 h-1.5 rounded-sm ${star <= doc.rating ? "bg-black" : "bg-zinc-100"}`}
                                    />
                                  ))}
                                </div>
                              </div>
              ...
              <div className="max-w-3xl mx-auto bg-white border border-zinc-100 p-16 space-y-12 rounded-sm">
                <div className="space-y-6">
                  ...
                  <p className="text-[11px] font-medium text-zinc-400 leading-relaxed italic">
                    Đồng bộ tri thức của bạn với hệ thống RAG để cho phép AI
                    thấu hiểu và hỗ trợ độc giả tốt hơn.
                  </p>
                  <button
                    onClick={handleIngestAI}
                    disabled={isIngesting || !selectedDocumentId}
                    className="h-14 bg-black text-white px-10 text-[10px] font-bold uppercase tracking-widest flex items-center gap-3 active:scale-[0.98] rounded-sm"
                  >
                    {isIngesting ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
                    ) : (
                ...
                <div className="space-y-8">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div className="space-y-4">
                      ...
                      <p className="text-[11px] font-medium text-zinc-400 leading-relaxed italic max-w-md">
                        Hệ thống sẽ phân tích nội dung để tạo ra một ảnh bìa
                        nghệ thuật phản ánh đúng linh hồn của tác phẩm.
                      </p>
                    </div>
                    <button
                      onClick={handleGenerateAICover}
                      disabled={generatingCover || !selectedDocumentId}
                      className="h-12 border border-black text-black px-8 text-[10px] font-bold uppercase tracking-widest flex items-center gap-3 active:scale-[0.98] rounded-sm"
                    >
                      {generatingCover ? (
                        <Loader2 className="w-4 h-4 animate-spin" />
                      ) : (
                  ...
                  <div className="relative group max-w-[280px] mx-auto lg:mx-0 rounded-sm overflow-hidden">
                    <div className="aspect-[3/4] bg-white border border-zinc-100 relative overflow-hidden grayscale rounded-sm">
                      {selectedDocument?.cover_url ? (
                        <img
                          src={
                            selectedDocument.cover_url.startsWith("http")
                              ? selectedDocument.cover_url
                              : `${API_URL}/storage/${selectedDocument.cover_url}`
                          }
                    ...
                    {selectedDocument?.cover_url && (
                      <div className="absolute -bottom-2 -right-2 bg-white border border-zinc-100 p-3 rounded-sm animate-in slide-in-from-top-2 ">
                ...
                <div className="py-20 text-center opacity-10">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest">
                    Cấu hình nâng cao đang cập nhật
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-3xl mx-auto space-y-10">
                <div className="bg-white border border-zinc-100 p-10 rounded-sm flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest">
                      Khôi phục tri thức tại các điểm thời gian
                    </p>
                  </div>
                ...
                <div className="space-y-4">
                  {loadingVersions ? (
                    ...
                    versions.map((v) => (
                      <div
                        key={v.id}
                        className="bg-white border border-zinc-100 p-8 flex items-center justify-between group rounded-sm"
                      >
                        <div className="flex items-center gap-6">
                        ...
                        <button
                          ...
                          className="h-10 px-6 border border-zinc-100 text-[9px] font-bold uppercase tracking-widest rounded-sm"
                        >
                          Khôi phục
                        </button>
                      </div>
                    ...
                    trash.map((doc) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="h-10 px-6 border border-zinc-100 text-[9px] font-bold uppercase tracking-widest rounded-sm flex items-center gap-2"
                        >
              ...
              <div className="max-w-4xl mx-auto space-y-12">
                <div className="bg-white border border-zinc-100 p-12 rounded-sm flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="h-10 px-6 border border-black text-[10px] font-bold uppercase tracking-widest rounded-sm flex items-center gap-2"
                  >
                    {loadingSentiment ? (
                ...
                {loadingSentiment ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="bg-white border border-zinc-100 p-12 rounded-sm space-y-8">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`px-4 py-1.5 text-[9px] font-bold uppercase tracking-widest rounded-sm ${sentimentData.sentiment === "positive" ? "bg-zinc-900 text-white" : "bg-zinc-100 text-zinc-400"}`}
                        >
                      ...
                      <p className="text-2xl font-bold tracking-tight text-black leading-tight italic">
                        ...
                        {sentimentData.summary ||
                          "Độc giả đang phản hồi rất tích cực về phong cách hành văn của bạn."}
                        "
                      </p>
                      <div className="pt-6 border-t border-zinc-50">
                        <p className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest mb-4">
                          Các điểm nhấn chính
                        </p>
                        <div className="space-y-3">
                          {(
                            sentimentData.highlights || [
                              "Cốt truyện lôi cuốn",
                      ...
                      <div className="space-y-8">
                        <div className="space-y-4">
                          ...
                          <p className="text-sm leading-relaxed text-zinc-500 font-medium italic">
                            {sentimentData.suggestions ||
                              "Nên đẩy nhanh nhịp độ ở các chương giữa để giữ chân độc giả tốt hơn."}
                          </p>
                        </div>
                        <div className="space-y-4">
                          <p className="text-xs font-bold text-black uppercase tracking-widest">
                          ...
                          <p className="text-sm leading-relaxed text-zinc-500 font-medium italic">
                            "Khai thác sâu hơn vào quá khứ của nhân vật phụ đang
                  ...
                  <div className="bg-white border border-dashed border-zinc-100 p-40 text-center rounded-sm">
                    ...
                    <p className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest">
                      Vui lòng chọn tài liệu để bắt đầu phân tích
                    </p>
                  </div>
                )}
              </div>
