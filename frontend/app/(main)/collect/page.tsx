  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto px-6 py-6 h-[calc(100dvh-var(--navbar-height))] flex flex-col font-sans text-black selection:bg-black selection:text-white">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 overflow-y-auto pb-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="border border-zinc-200 bg-zinc-50 rounded-2xl p-5 flex flex-col justify-between h-32">
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={`w-2 h-2 rounded-full ${collectorStats?.status === "operational" ? "bg-green-500" : "bg-red-500"}`}
                  />
        ...
        <main
          className="lg:col-span-9 flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-8 duration-300"
        ...
        >
          <section className="bg-[#0a0a0a] border border-zinc-800 rounded-2xl shadow-sm p-5 space-y-3 h-[450px] shrink-0 flex flex-col">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-3">
              ...
              <div className="text-[10px] font-mono font-medium tracking-widest uppercase text-zinc-500">
                Tiến trình thu thập
              </div>
            </div>
              ...
              {logs.map((log, index) => {
                ...
                return (
                  <div key={index} className="flex gap-2 sm:gap-3">
                    ...
                    <span className={`${levelColor} shrink-0 w-16 sm:w-20`}>
                      {parts.length >= 3 ? `[${level}]` : ""}
                    </span>
      ...
      >
        ...
        <ModalContent>
          <p className="text-xs font-medium text-zinc-500 leading-relaxed">
            Tiến trình thu thập dữ liệu từ nguồn bên ngoài sẽ được khởi tạo. Bạn
            có chắc chắn?
          </p>
        </ModalContent>
        <ModalFooter>
