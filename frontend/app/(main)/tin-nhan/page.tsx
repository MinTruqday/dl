...
export default function MessagesPage() {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-6 py-6 h-[calc(100dvh-56px)] flex flex-col font-sans text-[#1D1D1F]">
      ...
      <Modal isOpen={showGroupModal} onClose={() => setShowGroupModal(false)} className="max-w-md rounded-[18px] bg-[#F5F5F7] p-0 border-none shadow-2xl">
        <ModalHeader className="p-6">
      ...
      <Modal isOpen={showShareDocModal} onClose={() => setShowShareDocModal(false)} className="max-w-xl rounded-[18px] bg-[#F5F5F7] p-0 border-none shadow-2xl">
        <ModalHeader className="p-6">
