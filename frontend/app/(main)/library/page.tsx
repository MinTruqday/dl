...
export default function LibraryPage() {
  ...
  const handleCreateFolder = async () => {
    ...
    setIsCreating(true);
    try {
      const res = await createBookmarkFolderAPI(newFolderName.trim());
      if (res) {
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-12 font-sans text-black selection:bg-black selection:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div
          className="lg:col-span-8 space-y-12 delay-75"
          style={{
            opacity: visible ? 1 : 0,
            transform: visible ? "translateY(0)" : "translateY(10px)",
          }}
        ...
        <aside
          className="lg:col-span-4 space-y-10 delay-150"
          style={{
            opacity: visible ? 1 : 0,
            transform: visible ? "translateY(0)" : "translateY(10px)",
          }}
      ...
      >
        ...
        <ModalContent className="space-y-6">
          ...
          <div className="space-y-3">
            <label className="text-[9px] font-bold text-black uppercase tracking-widest">Tên thư mục</label>
            <input
              type="text"
              value={newFolderName}
        ...
        <ModalFooter className="flex gap-4">
          ...
          >
            {isCreating ? <Loader2 className="w-5 h-5 animate-spin" /> : "Tạo thư mục"}
          </button>
        </ModalFooter>
      </Modal>
    </div>
