    ...
    return (
        <div className="container max-w-7xl mx-auto py-10 px-6 font-sans">
            <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    <h1 className="text-4xl font-bold tracking-tighter text-foreground italic">Trung tâm Kiểm duyệt</h1>
                ...
                <div className="bg-muted px-4 py-2 rounded-sm border border-border flex items-center gap-2">
                    ...
                    <span className="text-[12px] font-bold tracking-widest">Vai trò: {user.role}</span>
                </div>
            </header>
                            ...
                            pendingDocuments.map((doc) => (
                                <div key={doc._id} className="bg-white border border-border rounded-sm overflow-hidden flex flex-col group hover:border-foreground transition-colors duration-300">
                                    ...
                                    <div className="p-4 bg-muted/20 border-t border-border flex items-center justify-between gap-2">
                                        <Button variant="outline" size="sm" className="h-9 px-4 rounded-none text-[12px] font-bold tracking-widest gap-2">
                    ...
                    <div className="bg-white border border-border rounded-sm overflow-hidden">
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm whitespace-nowrap">
                                <thead>
                                    <tr className="text-muted-foreground border-b border-border bg-muted/10 font-bold tracking-widest text-[12px]">
                                            ...
                                            <tr key={report._id} className="border-b border-border last:border-0 hover:bg-muted/10 transition-colors">
                                                <td className="p-4">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <div className="font-bold tracking-tight text-[13px]">{report.item_type}</div>
                                                            <div className="text-xs text-muted-foreground font-medium">{report.item_id}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="p-4">
                                                    <div className="font-bold text-rose-600 text-[12px] tracking-widest mb-1">{report.reason}</div>
                                                ...
                                                <td className="p-4 text-right">
                                                    <div className="flex justify-end gap-2">
                                                        <Button 
                                                            variant="secondary" 
                                                            size="sm" 
                                                            className="h-8 rounded-none text-[13px] font-bold tracking-widest"
