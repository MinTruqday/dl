...
export default function LibraryPage() {
 ...
 <div className="bg-[#F5F5F7] rounded-[18px] p-6">
 <h2 className="text-[20px] font-semibold text-[#1D1D1F]">Tài liệu đã ghim</h2>
 ...
 <section>
 <h2 className="text-[20px] font-semibold text-[#1D1D1F]">Đang đọc</h2>
 ...
 <Modal isOpen={isClearModalOpen} onClose={() => !isClearing && setIsClearModalOpen(false)} className="max-w-sm rounded-[18px] bg-[#F5F5F7] p-0 border-none -2xl">
 ...
 <Modal isOpen={isCreateModalOpen} onClose={() => !isCreating && setIsCreateModalOpen(false)} className="max-w-md rounded-[18px] bg-[#F5F5F7] p-0 border-none -2xl">
 <ModalHeader className="p-6">
...
function LibraryAISynthesisModal({ isOpen, onClose, availableDocuments }: { isOpen: boolean; onClose: () => void; availableDocuments: any[] }) {
 ...
 <div>
 <h2 className="text-[20px] font-semibold text-[#1D1D1F]">Tổng hợp AI</h2>
