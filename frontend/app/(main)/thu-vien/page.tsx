    ...
    <div className="w-full max-w-[1200px] mx-auto px-6 py-6 min-h-[calc(100dvh-56px)] font-sans text-[#1D1D1F]">
      <div className="flex flex-col lg:flex-row gap-8">
        <aside className="w-full lg:w-[280px] shrink-0 space-y-6">
          <div className="bg-[#F5F5F7] rounded-[18px] p-6">
            <p className="text-[13px] font-medium text-[#6E6E73] mb-4 mb-4">
              Quản lý thư viện
            </p>
                  ...
                  >
                    <div className="w-12 h-16 bg-[#D2D2D7] rounded-[8px] overflow-hidden shrink-0">
                      {doc.cover_url ? (
                        ...
                        <FileText className="w-5 h-5 text-white m-auto mt-5" />
                      )}
                    </div>
                  ...
                  >
                    <div className="aspect-[2/3] w-full rounded-[10px] bg-[#F5F5F7] overflow-hidden relative mb-3">
                      {doc.cover_url ? (
                        ...
                        <FileText className="w-10 h-10 text-[#D2D2D7] m-auto mt-[40%]" />
                      )}
                    ...
                    <p className="text-[13px] font-medium text-[#6E6E73] mb-4 line-clamp-2 leading-[1.3] group-hover:text-[#0071E3] transition-colors">
                      {doc.document_title}
                    </p>
                ...
                {history.length > 0 ? (
                  history.map((item, idx) => (
                    <div
                      ...
                      className={`group relative flex ${viewMode === "grid" ? "flex-col" : "flex-row gap-6 items-center p-4 rounded-[18px] hover:bg-[#F5F5F7] transition-colors"} ${isDeletingHistory === item.document_id ? "opacity-50" : ""}`}
                    >
                      <Link
                        href={`/document/${item.document_slug}`}
                        className={`${viewMode === "grid" ? "aspect-[2/3] w-full mb-3" : "w-16 h-24 shrink-0"} rounded-[12px] bg-[#F5F5F7] relative overflow-hidden block`}
                      >
                        {item.cover_url ? (
                          <img
                            src={
                          ...
                          <FileText className="w-8 h-8 text-[#D2D2D7] m-auto mt-[30%]" />
                        )}
                      ...
                      <div className="flex-1 min-w-0">
                        <Link href={`/document/${item.document_slug}`}>
                          <h3
                            className={`font-medium text-[#1D1D1F] line-clamp-2 leading-[1.3] group-hover:text-[#0071E3] transition-colors ${viewMode === "grid" ? "text-[17px]" : "text-[17px]"}`}
                          >
                            {item.document_title}
                          </h3>
                        </Link>
                      ...
                      <button
                        ...
                        className={`absolute ${viewMode === "grid" ? "top-2 right-2" : "right-4"} p-2 bg-white rounded-full text-[#6E6E73] hover:text-[#FF3B30] opacity-0 group-hover:opacity-100 transition-opacity`}
                      >
                ...
                {folders.length > 0 ? (
                  folders.map((folder) => (
                    ...
                    >
                      ...
                      <p className="text-[13px] font-medium text-[#6E6E73] mb-4 line-clamp-1">
                        {folder.name}
                      </p>
      ...
      >
        ...
        <ModalContent className="px-6 pb-6 text-[15px] text-[#6E6E73]">
          Bạn có chắc chắn muốn xóa toàn bộ lịch sử đọc? Hành động này không thể
          hoàn tác.
        </ModalContent>
