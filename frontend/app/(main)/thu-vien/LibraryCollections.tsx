...
import type { BookmarkFolder, ReadingList } from "./useLibrary";
  ...
  if (!folders.length)
    return (
      <EmptyState
        ...
        description="Tạo thư mục để nhóm các dấu trang theo chủ đề"
      />
    );
  return (
  ...
  if (!lists.length)
    return (
      <EmptyState
        ...
        description="Tạo danh sách để lưu các tài liệu cần đọc cùng nhau"
      />
    );
  return (
    <div className="overflow-hidden rounded-panel border border-border bg-surface">
