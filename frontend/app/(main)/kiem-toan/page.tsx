...
import { AuditLog, useAuditLogs } from "./useAuditLogs";
...
export default function AuditPage() {
  ...
  const metricItems = [
    ...
    },
    {
      ...
      detail: "Mức nghiêm trọng cao",
    },
    {
      label: "Thao tác quản trị",
      value: stats?.admin_actions ?? 0,
      detail: "Quyền hạn đặc biệt",
    },
  ];
    ...
    <div className="w-full space-y-6">
              ...
              {logs.map((log, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="max-w-[12rem] truncate px-4 py-3.5 font-mono text-[12px] font-semibold text-ink">
      ...
      {selectedLog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="relative max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-panel border border-border bg-surface p-6 shadow-2xl">
