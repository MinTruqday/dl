...
export default function DocumentsPage() {
 ...
 <td className="py-3 px-6"><div className="flex items-center gap-4"><div className="w-10 h-10 bg-white  flex items-center justify-center rounded-[12px] text-[#1D1D1F]"><Folder className="w-5 h-5"/></div><span className="font-medium text-[#1D1D1F]">{folder.name}</span></div></td>
 ...
 <div className="p-2 bg-white rounded-xl "><QRCodeSVG value={publicUrl} size={100} /></div>
 </div>
 )}
 </form>
 </ModalContent>
