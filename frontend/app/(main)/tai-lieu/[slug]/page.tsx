    ...
    <div className="w-full max-w-[1200px] mx-auto px-6 py-12 font-sans text-[#1D1D1F]">
      ...
      <div className="flex flex-col md:flex-row gap-12 mb-12">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-[#E8E8ED]">
            <div className="w-12 h-12 rounded-full overflow-hidden bg-[#F5F5F7] border border-[#E8E8ED]">
