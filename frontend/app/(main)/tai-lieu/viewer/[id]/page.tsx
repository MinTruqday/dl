...
export default function DocumentViewer() {
 ...
 selectedZipFile.type === "text" ? <pre className="text-[13px] font-mono text-[#1D1D1F] whitespace-pre-wrap leading-relaxed bg-[#F5F5F7] p-6 rounded-[18px] ">{selectedZipFile.content}</pre> : <div className="flex h-full flex-col items-center justify-center text-[#6E6E73]"><AlertTriangle className="w-12 h-12 mb-4 text-[#C7C7CC]" /><p className="text-[13px]">Định dạng không được hỗ trợ hiển thị</p></div>
 ...
 <p className="text-[13px] font-medium text-[#6E6E73] mb-4 mb-2">Thực thể bảo mật</p>
 <p className="text-[15px] text-[#6E6E73] mb-8">Nhập mã định danh để tiếp cận dữ liệu</p>
 <div className="w-full space-y-4">
 <input type="password" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => e.key === "Enter" && fetchDocument(password)} placeholder="" className="w-full h-[52px] bg-[#F5F5F7] border border-transparent px-4 text-center text-[15px] focus:outline-none focus:border-[#0071E3] focus:bg-white rounded-[10px] transition-all" />
 ...
 <button onClick={() => setSidebarTab("chat")} className={`p-3 rounded-xl transition-colors ${sidebarTab === "chat" ? "bg-[#0071E3] text-white " : "text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-[#F5F5F7]"}`}><Bot className="w-6 h-6" /></button>
 <button onClick={() => setSidebarTab("highlights")} className={`p-3 rounded-xl transition-colors ${sidebarTab === "highlights" ? "bg-[#0071E3] text-white " : "text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-[#F5F5F7]"}`}><Highlighter className="w-6 h-6" /></button>
 <button onClick={() => setSidebarTab("thumbnails")} className={`p-3 rounded-xl transition-colors ${sidebarTab === "thumbnails" ? "bg-[#0071E3] text-white " : "text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-[#F5F5F7]"}`}><BookOpen className="w-6 h-6" /></button>
 <button onClick={() => setSidebarTab("history")} className={`p-3 rounded-xl transition-colors ${sidebarTab === "history" ? "bg-[#0071E3] text-white " : "text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-[#F5F5F7]"}`}><History className="w-6 h-6" /></button>
 {document?.content_format === "zip" && <button onClick={() => setSidebarTab("zip")} className={`p-3 rounded-xl transition-colors ${sidebarTab === "zip" ? "bg-[#0071E3] text-white " : "text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-[#F5F5F7]"}`}><Folder className="w-6 h-6" /></button>}
 </div>
 ...
 <div className={`w-10 h-10 shrink-0 flex items-center justify-center rounded-full ${msg.role === "user" ? "bg-[#F5F5F7] " : "bg-[#0071E3] text-white"}`}>{msg.role === "user" ? <User className="w-5 h-5 text-[#6E6E73]" /> : <Bot className="w-5 h-5" />}</div>
