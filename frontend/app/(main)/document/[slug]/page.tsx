...
export default function DocumentDetailsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "about" | "chapters" | "preview" | "reviews" | "comments"
  >("about");
      ...
      <div className="w-full max-w-5xl mx-auto px-6 py-12 font-sans bg-white text-black selection:bg-black selection:text-white min-h-screen">
            ...
            <div className="w-48 md:w-full aspect-[2/3] border border-zinc-200 bg-zinc-50 flex items-center justify-center rounded-2xl overflow-hidden relative">
              {docData.cover_image ? (
                ...
                <div className="flex flex-col items-center gap-4 text-center p-6">
                  ...
                  <span className="text-xs font-medium text-zinc-500 line-clamp-3">
                    {docData.title}
                  </span>
                </div>
              )}
            ...
            <div className="p-4 border border-zinc-200 bg-zinc-50 flex items-start gap-3 rounded-3xl mt-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-zinc-600">
                  Tài liệu đã được kiểm định chất lượng và đảm bảo tính toàn
                  vẹn.
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-12 items-start">
          <div className="w-full space-y-8">
            <div
              id="document-tabs"
              className="border-b border-zinc-200 flex gap-8 overflow-x-auto scrollbar-hide"
            >
              {[
