        ...
        <aside className="w-full md:w-[320px] shrink-0 flex flex-col space-y-6 overflow-y-auto no-scrollbar pb-6 pr-2">
          <div className="bg-[#F5F5F7] rounded-[18px] p-6 space-y-4">
            ...
            <div className="flex flex-col gap-2">
              <button className="pill-button w-full justify-center flex items-center gap-2">
                Thêm mới
              </button>
            </div>
          </div>
            ...
            <table className="w-full text-left text-[14px] border-collapse">
              <thead>
                <tr className="text-[13px] text-[#6E6E73]">
                  ...
                  <th className="py-3 px-6 font-medium text-right w-[10%]">
                    Thao tác
                  </th>
                </tr>
              </thead>
                  ...
                  >
                    <td className="py-3 px-6">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 bg-[#F5F5F7] text-[#1D1D1F] flex items-center justify-center font-semibold rounded-full overflow-hidden shrink-0 ">
                          {u.avatar_url ? (
                            <img
                              src={u.avatar_url}
                              alt=""
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-[12px] text-[#6E6E73] flex items-center gap-1 mt-0.5">
                    ...
                    <td className="py-3 px-6">
                      <div className="relative inline-block w-full max-w-[150px]">
                        <select
                          ...
                          className={`w-full bg-[#F5F5F7] h-[32px] px-3 text-[13px] font-medium rounded-full focus:outline-none appearance-none transition-colors border border-transparent hover:border-[#E8E8ED] ${u.role === "admin" ? "text-[#0071E3] bg-[#E8F3FF]" : "text-[#1D1D1F]"}`}
                        >
                    ...
                    <td className="py-3 px-6 text-[#6E6E73]">
                      {u.created_at
                    ...
                    <td className="py-3 px-6">
                      <div
                        className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[12px] font-medium ${u.is_active ? "bg-[#E8F5E9] text-[#34C759]" : "bg-[#FF3B30]/10 text-[#FF3B30]"}`}
                      >
                        <div
                          className={`w-1.5 h-1.5 rounded-full ${u.is_active ? "bg-[#34C759]" : "bg-[#FF3B30]"}`}
                        ></div>
                    ...
                    <td className="py-3 px-6 text-right relative">
                      <button
                        ...
                        className="p-2 text-[#6E6E73] hover:text-[#1D1D1F] hover:bg-[#E8E8ED] rounded-full transition-colors opacity-0 group-hover:opacity-100"
                      >
                        ...
                        <>
                          ...
                          <div className="absolute right-6 top-10 mt-1 w-44 bg-white  rounded-[10px] z-50 overflow-hidden py-1">
                            ...
                            <button
                              ...
                              className="w-full text-left px-4 py-2 text-[14px] text-[#1D1D1F] hover:bg-[#F5F5F7] transition-colors flex items-center gap-2"
                            >
                              <AlertTriangle className="w-4 h-4 text-[#6E6E73]" />{" "}
                              Cảnh báo
                            </button>
                    ...
                    <td colSpan={5} className="py-24 text-center">
                      <div className="flex flex-col items-center justify-center max-w-sm mx-auto">
                        <div className="w-16 h-16 bg-[#F5F5F7] rounded-[16px] flex items-center justify-center mb-4">
                          <Search className="w-8 h-8 text-[#C7C7CC]" />
                        </div>
