...
import { Brain, Sparkles, Loader2, Eye, Star, TrendingUp, BarChart3, Award, BookOpen } from "lucide-react";
...
export default function AuthorAnalyticsPage() {
 ...
 {[
 { label: "Lượt xem", val: revenue?.total_views || 0, icon: Eye, color: "text-[#0071E3]", bg: "bg-[#0071E3]/10" },
 { label: "Lượt đánh giá", val: 0, icon: Star, color: "text-[#FF9500]", bg: "bg-[#FF9500]/10" },
 ...
 <div key={i} className="bg-[#F5F5F7] rounded-[18px] border-[#E8E8ED] p-6 flex flex-col gap-4">
 <div className={`w-12 h-12 rounded-[10px] flex items-center justify-center ${item.bg}`}>
 ...
 <p className="text-[13px] font-medium text-[#6E6E73] mb-4 mb-2">Đang phân tích dữ liệu chuyên sâu</p>
