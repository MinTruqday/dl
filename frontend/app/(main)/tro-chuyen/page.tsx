...
const PayOSEmbedded = ({ checkoutUrl }: { checkoutUrl: string }) => {
                        ...
                        <div className="relative">
                          ...
                          {openDropdownId === s._id && (
                            <>
                              ...
                              />
                              <div className="absolute right-0 top-full mt-1 w-36 p-1.5 bg-white border border-zinc-200 rounded-2xl shadow-lg z-50">
                                <button
                                ...
                                <button
                                  ...
                                  className="w-full text-left px-3 py-2 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 rounded-xl transition-colors flex items-center gap-2"
                                >
        ...
        {true && (
          <main className="lg:col-span-9 flex flex-col h-[calc(100vh-140px)] bg-white border border-zinc-200 rounded-2xl shadow-sm relative overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-300">
                            ...
                            {(() => {
                              ...
                              return (
                                <>
                                  {msg.thoughts && msg.thoughts.length > 0 && (
                                    <div className="mb-3 flex flex-wrap gap-2">
                                      {msg.thoughts.map((t, i) => (
                                        <span
                                          key={i}
                                          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-zinc-100 border border-zinc-200 text-[11px] font-semibold text-zinc-600 whitespace-nowrap"
                                        >
                                  ...
                                  <div className="absolute top-2 right-2 flex items-center gap-1 opacity-0 group-hover:opacity-100 z-10 bg-white border border-zinc-100 rounded-md">
                                    <button
                                      onClick={() => {
                                                ...
                                                <div className="my-6 grid grid-cols-1 sm:grid-cols-2 gap-4 not-prose">
                                                  {cards.map(
                                                    (card: any, i: number) => (
                                                      <div
                                                        key={i}
                                                        className="group relative border border-black bg-white p-6 cursor-pointer rounded-none"
                                                        onClick={(e) => {
                                                          const front =
                                                      ...
                                                      >
                                                        <div className="absolute top-3 right-3 px-2 py-1 bg-black text-white text-[9px] font-bold uppercase tracking-widest">
                                                          Card {i + 1}
                                                        </div>
                                                        <div className="fc-front font-bold text-lg text-black mt-4">
                                                          {card.front ||
                                                            card.question}
                                                        </div>
                                                        <div className="fc-back hidden font-medium text-zinc-600 text-base mt-4 border-t border-black pt-4">
                                                          {card.back ||
                                                            card.answer}
                                                        </div>
                                                        <div className="text-[10px] text-zinc-400 mt-6 uppercase tracking-widest border-t border-zinc-200 pt-2 text-center">
                                                          Bấm để lật thẻ
                                                        </div>
                                                      </div>
                                                    ),
                                            ...
                                            try {
                                              ...
                                              return (
                                                <div className="my-8 p-8 border border-black bg-zinc-50 overflow-x-auto not-prose relative">
                                                  <div className="absolute top-0 right-0 bg-black text-white px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest">
                                                    Bản đồ tư duy
                                                  </div>
            ...
            <div className="shrink-0">
              <div className="px-6 pb-6 pt-2 shrink-0 relative flex justify-center">
