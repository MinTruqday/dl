...
export default function TroChuyenPage() {
 ...
 <span key={i} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#F5F5F7]  text-[12px] font-medium text-[#6E6E73] whitespace-nowrap">
 ...
 <img src={selectedImage.data} alt="" className="h-16 w-16 object-cover  rounded-[14px]" />
