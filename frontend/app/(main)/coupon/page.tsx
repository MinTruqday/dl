...
export default function ManageCouponsPage() {
  ...
  return (
    <section className="bg-white border border-zinc-200 rounded-2xl shadow-sm p-5 space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-300">
      <div className="mb-2 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-1.5 border border-transparent rounded-xl text-zinc-500 hover:text-black hover:bg-zinc-100 transition-all duration-150"
          >
          ...
          <div className="flex border border-zinc-200 bg-zinc-50 rounded-xl overflow-hidden">
            <button
              ...
              className={`p-1.5 transition-all duration-150 ${viewMode === "grid" ? "bg-white text-black shadow-sm" : "bg-transparent text-zinc-500 hover:text-black"}`}
            >
              <LayoutGrid className="w-4 h-4" />
            </button>
            <button
              onClick={() => setViewMode("list")}
              className={`p-1.5 transition-all duration-150 ${viewMode === "list" ? "bg-white text-black shadow-sm" : "bg-transparent text-zinc-500 hover:text-black"}`}
            >
      ...
      >
        <ModalHeader>
          <ModalTitle>Thiết lập ưu đãi mới</ModalTitle>
        </ModalHeader>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full h-10 bg-zinc-50 border border-zinc-200 px-3 text-xs font-mono font-semibold focus:outline-none focus:border-black rounded-xl"
              />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-semibold text-black uppercase tracking-widest">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full h-10 bg-zinc-50 border border-zinc-200 px-3 text-xs font-medium focus:outline-none focus:border-black rounded-xl appearance-none cursor-pointer"
              >
        ...
        <ModalFooter>
          <button
            ...
            className="flex-1 h-10 border border-zinc-200 bg-white text-xs font-semibold uppercase tracking-wider rounded-xl hover:bg-zinc-50 transition-colors"
          >
            Hủy bỏ
          </button>
          <button
            ...
            disabled={creating}
            className="flex-1 h-10 bg-black text-white text-xs font-semibold uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50 rounded-xl border border-black hover:bg-zinc-800 transition-colors"
          >
            {creating ? (
      ...
      >
        ...
        <ModalContent className="p-6">
          <p className="text-xs font-medium text-zinc-500 leading-relaxed">
            Xóa mã "{deleteConfirm?.code}"? Hành động này không thể hoàn tác.
          </p>
        </ModalContent>
        <ModalFooter className="flex gap-3 border-t border-zinc-200 p-4 bg-zinc-50">
          <button
            ...
            disabled={isDeleting}
            className="flex-1 py-2 border border-zinc-200 bg-white text-xs font-medium text-black rounded-xl hover:bg-zinc-50 transition-colors"
          >
            Hủy bỏ
          </button>
          <button
            ...
            disabled={isDeleting}
            className="flex-1 py-2 bg-black border border-black text-white text-xs font-medium flex items-center justify-center rounded-xl hover:bg-zinc-800 transition-colors"
          >
            {isDeleting ? (
