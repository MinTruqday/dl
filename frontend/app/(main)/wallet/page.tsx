  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center h-[70vh] gap-10 font-sans px-6 text-center">
        <div className="w-24 h-24 bg-white flex items-center justify-center border border-zinc-100 rounded-sm">
        ...
        <button
          ...
          className="bg-black text-white h-16 px-12 text-[11px] font-bold uppercase tracking-widest active:scale-95 rounded-sm"
        >
          Đăng nhập ngay
        </button>
      </div>
    ...
    <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-10 font-sans text-black selection:bg-black selection:text-white">
      ...
      >
        <ModalHeader>
          <div className="flex items-center gap-4">
            ...
            <div>
              <ModalTitle>Nạp tài nguyên</ModalTitle>
              <ModalDescription>Thanh toán an toàn qua cổng tích hợp</ModalDescription>
            </div>
          </div>
        </ModalHeader>
        ...
        <ModalContent>
          <div className="space-y-8">
            <div className="space-y-6">
              <label className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest flex items-center gap-2 px-1">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[50000, 100000, 200000, 500000].map((amt) => (
                  <button
                    ...
                    className={`h-20 border text-[13px] font-bold tracking-tighter active:scale-[0.98] rounded-sm transition-all ${
                      topupAmount === amt
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full h-16 bg-white border border-zinc-100 px-8 text-center text-lg font-bold tracking-tighter outline-none focus:border-black rounded-sm transition-colors"
                />
                <div className="absolute right-8 top-1/2 -translate-y-1/2 text-[10px] font-bold text-zinc-300 uppercase tracking-widest">
                  VNĐ
                </div>
              </div>
            </div>

            <div className="bg-white p-8 flex items-center justify-between border border-zinc-100 rounded-sm">
              <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
                Tỷ giá quy đổi nền tảng
              </span>
              <span className="text-sm font-bold text-black tracking-tight">
                1.000 VNĐ đổi <span className="text-lg">1 dl</span>
              </span>
            </div>
            ...
            <button
              ...
              className="w-full h-20 bg-black text-white text-[11px] font-bold uppercase tracking-[0.2em] active:scale-[0.98] flex items-center justify-center gap-4 disabled:opacity-50 rounded-sm transition-transform"
            >
              {topupLoading ? (
                <Loader2 className="w-6 h-6 animate-spin" />
              ) : (
                "Bắt đầu thanh toán ngay"
              )}
            </button>
          </div>
        </ModalContent>
      ...
      >
        ...
        <button
          ...
          className="bg-black text-white h-16 px-12 text-[11px] font-bold uppercase tracking-[0.2em] active:scale-95 flex items-center gap-4 rounded-sm"
        >
      ...
      <div className="grid lg:grid-cols-12 gap-12">
        <aside
          className="lg:col-span-4 space-y-12 delay-75"
          style={{
            opacity: visible ? 1 : 0,
            transform: visible ? "translateY(0)" : "translateY(10px)",
          }}
        >
          <div className="bg-white border border-zinc-100 p-12 rounded-sm">
            <div className="space-y-10">
              <div className="flex flex-col gap-2">
                <p className="text-zinc-300 text-[10px] font-bold uppercase tracking-[0.2em]">
                  Năng lượng tri thức
                </p>
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="text-xl font-bold text-zinc-200 italic">
                    dl
                  </span>
                </div>
              </div>
              ...
              <div className="pt-10 border-t border-zinc-50 flex flex-col gap-6">
                <div className="flex items-center justify-between">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2 text-[10px] font-bold text-black uppercase">
                      <div className="w-2 h-2 bg-black animate-pulse rounded-sm" />{" "}
                      Xác thực toàn cầu
                    </div>
                  </div>
                ...
                <div className="p-4 bg-white border border-zinc-100 text-[10px] font-medium text-zinc-400 italic rounded-sm">
          ...
          <div className="bg-white border border-zinc-100 p-8 space-y-6 rounded-sm">
            <div className="space-y-1">
              ...
              <p className="text-[9px] font-bold text-zinc-300 uppercase tracking-widest">
                Sử dụng mã quà tặng từ đối tác
              </p>
            </div>
            <form onSubmit={handleRedeemVoucher} className="space-y-4">
              <input
                ...
                placeholder=""
                className="w-full h-16 bg-white border border-zinc-100 px-6 text-center text-sm font-bold tracking-widest outline-none focus:border-black rounded-sm"
              />
              <button
                type="submit"
                disabled={isRedeeming || !voucherCode.trim()}
                className="w-full h-16 bg-white text-black border border-zinc-100 text-[11px] font-bold uppercase tracking-widest active:scale-[0.98] disabled:opacity-50 rounded-sm"
              >
                {isRedeeming ? (
            ...
            <div className="px-10 py-10 border-b border-zinc-100 flex items-center justify-between">
              <div className="space-y-1">
                <h3 className="text-2xl font-bold text-black tracking-tighter flex items-center gap-4">
                  <History className="w-6 h-6 text-zinc-200" /> Nhật ký giao
                  dịch
                </h3>
                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">
                  Theo dõi dòng chảy tài nguyên của bạn
                </p>
              </div>
              <div className="px-5 py-2 bg-white border border-zinc-100 text-[10px] font-bold text-zinc-400 uppercase tracking-widest rounded-sm">
              ...
              {isLoading ? (
                ...
                <div className="py-48 text-center flex flex-col items-center gap-8">
                  ...
                  <div className="space-y-2">
                    <p className="text-[11px] font-bold text-zinc-300 uppercase tracking-[0.4em]">
                      Nhật ký đang trống
                    </p>
                    <p className="text-[9px] font-bold text-zinc-200 uppercase tracking-widest italic">
                      Hãy bắt đầu nạp năng lượng tri thức ngay hôm nay
                    </p>
                  </div>
                </div>
              ) : (
                <div className="divide-y divide-zinc-50">
                  {history.map((tx) => (
                    <div
                      key={tx._id}
                      className="px-10 py-10 flex items-center justify-between group"
                    >
                      <div className="flex items-center gap-10">
                        <div
                          className={`w-16 h-16 flex items-center justify-center border rounded-sm ${
                            tx.type === "TOPUP"
                              ? "bg-black text-white border-black"
                        ...
                        <div className="space-y-2">
                          <p className="text-[17px] font-bold text-black tracking-tight transition-transform ">
                            {tx.note ||
                              (tx.type === "TOPUP"
                                ? "Nạp năng lượng tri thức"
                                : "Trao đổi tri thức")}
                          </p>
                          <div className="flex items-center gap-4">
                      ...
                      <div className="text-right space-y-3">
                        ...
                        >
                          ...
                          <span className="text-[10px] italic ml-1">dl</span>
                        </p>
                        <div className="flex justify-end">
                          ...
                          >
                            <div
                              className={`w-1.5 h-1.5 rounded-full ${tx.status === "COMPLETED" ? "bg-black" : "bg-zinc-200"}`}
                            />
