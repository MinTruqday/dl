...
export default function CommentsPage() {
 ...
 <div className="w-12 h-12 bg-white rounded-[14px] flex items-center justify-center shrink-0"><BookOpen className="w-6 h-6 text-[#1D1D1F]" /></div>
 <div>
 ...
 <span className="px-4 py-1.5 bg-white text-[#1D1D1F] text-[13px] font-medium rounded-full">{comments.length} phản hồi</span>
 </div>
 ...
 <input type="text" value={replyContent} onChange={(e) => setReplyContent(e.target.value)} placeholder="" className="w-full h-[48px] pl-12 pr-4 bg-[#F5F5F7] focus:bg-white text-[15px] text-[#1D1D1F] rounded-[14px] outline-none focus:border-[#0071E3] transition-colors" autoFocus onKeyDown={(e) => { if (e.key === 'Enter') handleReplyComment(); if (e.key === 'Escape') setReplyingTo(null); }} />
 </div>
