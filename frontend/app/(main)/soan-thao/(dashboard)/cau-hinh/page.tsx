...
export default function ConfigPage() {
 ...
 {docTags.map((tag) => (
 <span key={tag} className="flex items-center gap-1 bg-[#F5F5F7] px-3 py-1.5 text-[13px] font-medium text-[#1D1D1F] rounded-[10px] group">
 ...
 <div className={`w-[48px] h-[28px] rounded-full flex items-center p-1 transition-colors ${drmCopy ? "bg-[#34C759] border-[#34C759]" : "bg-[#E8E8ED] border-[#D2D2D7]"}`}>
 ...
 <div className={`w-[48px] h-[28px] rounded-full flex items-center p-1 transition-colors ${drmSearch ? "bg-[#34C759] border-[#34C759]" : "bg-[#E8E8ED] border-[#D2D2D7]"}`}>
 ...
 <button onClick={() => setConfirmTransfer(false)} className="flex-1 h-[44px] bg-white text-[15px] font-medium text-[#1D1D1F] rounded-full hover:bg-[#E8E8ED] transition-colors">Hủy bỏ</button>
