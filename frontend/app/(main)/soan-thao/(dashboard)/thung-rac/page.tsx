...
export default function TrashPage() {
 ...
 <button onClick={() => handleRestoreDocument(doc._id || doc.id)} className="w-full sm:w-auto h-[44px] px-6 bg-white text-[15px] font-medium text-[#1D1D1F] rounded-full flex items-center justify-center gap-2 hover:bg-[#F5F5F7] hover:text-[#0071E3] transition-colors sm:opacity-0 sm:group-hover:opacity-100">
