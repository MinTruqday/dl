...
export default function ApprovalPage() {
 ...
 <button onClick={() => setConfirmModal({ type: "reject", data: doc })} className="flex-1 h-[44px] bg-white border-[#FF3B30]/30 text-[#FF3B30] hover:bg-[#FFEBEB] text-[15px] font-medium rounded-full transition-colors flex items-center justify-center gap-2">
 ...
 <button onClick={() => setConfirmModal(null)} className="flex-1 h-[44px] bg-white text-[15px] font-medium text-[#1D1D1F] rounded-full hover:bg-[#E8E8ED] transition-colors">Hủy bỏ</button>
