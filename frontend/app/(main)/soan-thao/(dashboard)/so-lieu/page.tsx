...
export default function StatsPage() {
 ...
 <Modal isOpen={showAnalyticsModal} onClose={() => setShowAnalyticsModal(false)} className="max-w-3xl rounded-[24px] border-[#E8E8ED] bg-[#F5F5F7] p-0 overflow-hidden">
 ...
 <div className="flex items-center gap-2 pb-3"><Eye className="w-5 h-5 text-[#1D1D1F]" /><h3 className="text-[17px] font-medium text-[#1D1D1F]">Tương tác độc giả</h3></div>
 ...
 <div className="space-y-4">
 <div className="flex items-center gap-2 pb-3"><BookOpen className="w-5 h-5 text-[#1D1D1F]" /><h3 className="text-[17px] font-medium text-[#1D1D1F]">Chỉ số học thuật</h3></div>
 ...
 <Modal isOpen={showWithdrawalModal} onClose={() => !requestingWithdrawal && setShowWithdrawalModal(false)} className="max-w-md rounded-[24px] border-[#E8E8ED] bg-[#F5F5F7] p-0 overflow-hidden">
 ...
 <div className="bg-[#34C759]/10 p-4 rounded-[14px] flex items-center justify-between border-[#34C759]/20"><span className="text-[13px] font-medium text-[#1D1D1F]">Số dư khả dụng:</span><span className="text-[17px] font-semibold text-[#34C759]">{revenue?.available_balance || 0} dl</span></div>
 <div className="space-y-4">
 <div className="space-y-2"><label className="text-[13px] font-medium text-[#1D1D1F]">Số tiền cần rút (dl)</label><div className="relative"><Banknote className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#6E6E73]" /><input type="number" value={withdrawalAmount || ""} onChange={(e) => setWithdrawalAmount(parseInt(e.target.value) || 0)} placeholder="" className="w-full h-[48px] pl-12 pr-4 text-[15px] text-[#1D1D1F] rounded-[14px] outline-none focus:border-[#0071E3] bg-[#F5F5F7] focus:bg-white transition-colors" /></div></div>
 <div className="space-y-2"><label className="text-[13px] font-medium text-[#1D1D1F]">Tên ngân hàng</label><input value={bankInfo.bank_name} onChange={(e) => setBankInfo({ ...bankInfo, bank_name: e.target.value })} placeholder="" className="w-full h-[48px] px-4 text-[15px] text-[#1D1D1F] rounded-[14px] outline-none focus:border-[#0071E3] bg-[#F5F5F7] focus:bg-white transition-colors" /></div>
 <div className="space-y-2"><label className="text-[13px] font-medium text-[#1D1D1F]">Số tài khoản</label><input value={bankInfo.account_number} onChange={(e) => setBankInfo({ ...bankInfo, account_number: e.target.value })} placeholder="" className="w-full h-[48px] px-4 text-[15px] text-[#1D1D1F] rounded-[14px] outline-none focus:border-[#0071E3] bg-[#F5F5F7] focus:bg-white transition-colors" /></div>
 <div className="space-y-2"><label className="text-[13px] font-medium text-[#1D1D1F]">Tên chủ tài khoản</label><input value={bankInfo.account_name} onChange={(e) => setBankInfo({ ...bankInfo, account_name: e.target.value })} placeholder="" className="w-full h-[48px] px-4 text-[15px] text-[#1D1D1F] rounded-[14px] outline-none focus:border-[#0071E3] bg-[#F5F5F7] focus:bg-white transition-colors uppercase" /></div>
 </div>
 </div>
 </ModalContent>
 ...
 <Modal isOpen={showPricingModal} onClose={() => setShowPricingModal(false)} className="max-w-md rounded-[24px] border-[#E8E8ED] bg-[#F5F5F7] p-6">
 ...
 <div className="relative"><input type="number" min="0" value={newPrice} onChange={(e) => setNewPrice(Number(e.target.value))} className="w-full h-[52px] pl-4 pr-12 rounded-[14px] text-[15px] font-medium bg-[#F5F5F7] focus:bg-white focus:border-[#0071E3] outline-none transition-all" placeholder="" /><span className="absolute right-4 top-1/2 -translate-y-1/2 text-[15px] font-medium text-[#6E6E73]">dl</span></div>
