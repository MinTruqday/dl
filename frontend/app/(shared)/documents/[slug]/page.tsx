  ...
  const handleShare = () => {
    if (typeof navigator !== "undefined" && navigator.share) {
      navigator
        ...
        .catch(() => {
          showToast("Không thể thực hiện chia sẻ", "error");
        });
    } else {
              ...
              <div className="flex flex-wrap items-center gap-16 pt-6">
                ...
                >
                  ...
                  <div className="flex flex-col items-start space-y-0.5">
                    ...
                    <span className="text-sm font-bold text-black uppercase tracking-tight underline-offset-4">
                      {docData.author?.display_name ||
              ...
              <div className="space-y-6 pt-8 border-t border-zinc-100">
                ...
                <div className="p-10 border border-zinc-100 bg-white space-y-8 rounded-sm">
                  <p className="text-[11px] font-medium text-zinc-400 leading-loose uppercase tracking-tight">
                    Tài liệu đã được hội đồng chuyên môn DocLib kiểm định chất
                    lượng và đảm bảo tính toàn vẹn tri thức.
                  </p>
                      ...
                      <div className="pt-10 border-t border-zinc-100 space-y-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                          {docData.tags.map((tag: string, i: number) => (
                            <span
                              key={i}
                              className="px-8 py-3 bg-white border border-zinc-100 text-[10px] font-bold text-zinc-400 cursor-pointer uppercase tracking-[0.2em] rounded-sm"
                            >
                              #{tag}
                            </span>
                          ))}
                ...
                {activeTab === "preview" && (
                  <div className="space-y-16">
                    {(() => {
                      ...
                      const contentToDisplay = canSeeFull
                        ? rawContent
                        : rawContent.slice(0, previewLimit * 1000);
                                ...
                                {docData.content ? (
                                  ...
                                  <div className="space-y-12">
                                    <p className="first-letter:text-8xl first-letter:font-bold first-letter:mr-6 first-letter:float-left first-letter:text-black tracking-tight">
                                      Dữ liệu của thực thể tri thức "
                                      {docData.title}" đang được trích xuất và
                                      hiển thị theo tiêu chuẩn DocLib.
                                    </p>
                                    <p className="text-zinc-400 font-sans text-xl leading-loose">
                                      {docData.description ||
                                        "Thực thể này là một phần cốt lõi trong hạ tầng tri thức của chúng tôi."}
                                    </p>
                                  </div>
                                )}
                              </div>
                              ...
                              <div className="mt-60 pt-60 border-t border-zinc-100 flex flex-col items-center text-center space-y-14 relative">
                                ...
                                <div className="relative z-20 space-y-10 pb-32">
                                  ...
                                  <div className="space-y-6">
                                    <h3 className="text-4xl font-bold text-black tracking-tighter uppercase">
                                      Rào cản tri thức
                                    </h3>
                                    <p className="text-[11px] font-bold text-zinc-300 leading-relaxed uppercase tracking-[0.3em] max-w-xl mx-auto">
                                      Bạn đã tiếp cận hết giới hạn xem trước cho
                                      phép. <br />
                                      Mở khóa để khám phá toàn bộ{" "}
                                      {docData.pages_count} trang tri thức
                                      chuyên sâu.
                                    </p>
                                  </div>
                                  <button
