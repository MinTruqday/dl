  ...
  const NavLink = ({
    ...
    return (
      <Link
        ...
        className={`
          flex items-center text-[10px] font-black tracking-widest
      ...
      >
        ...
        {!isOpen && !isMobileOverlay && (
          <span className="absolute left-full ml-2 px-3 py-2 bg-black text-white text-[9px] font-black tracking-widest whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-200 z-50 transform translate-x-2 group-hover:translate-x-0">
            {label}
          </span>
        )}
      </Link>
