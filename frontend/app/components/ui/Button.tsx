...
export function Button({ 
  ...
  const sClass = {
    sm: 'px-3 py-1.5 text-[10px] font-black tracking-widest border',
    md: 'px-5 py-2.5 text-xs font-black tracking-widest border',
    lg: 'px-8 py-4 text-sm font-black tracking-widest border border-2',
