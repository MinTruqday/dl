              ...
              <>
                  ...
                  {showNotifications && (
                    <div className="absolute right-0 mt-2 w-80 bg-white rounded-none border border-zinc-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                      <div className="px-5 py-4 border-b border-zinc-50 flex items-center justify-between bg-zinc-50/50">
                        ...
                        {unreadCount > 0 && (
                          <span className="px-2 py-0.5 bg-zinc-900 text-white text-[13px] font-bold  rounded-none">
                            {unreadCount} mới
                          </span>
                        )}
                      </div>
                              ...
                              >
                                <div className="flex gap-3 items-start">
                                  ...
                                  <div className={!notif.is_read ? "" : "pl-4"}>
                                    ...
                                    <span className="text-[12px] text-zinc-400 mt-1.5 block font-bold tracking-tight">
                      ...
                      <Link 
                         ...
                         className="block py-4 text-center text-[12px] font-bold tracking-wider text-zinc-400 hover:text-black border-t border-zinc-50 bg-zinc-50/50 transition-all hover:bg-zinc-100"
                      >
                         Xem tất cả
                      </Link>
                    </div>
                ...
                <div className="relative" ref={userMenuRef}>
                  ...
                  >
                    ...
                    <span className="text-xs font-bold  tracking-widest text-zinc-900 hidden sm:block max-w-[120px] truncate">
                  ...
                  {showUserMenu && (
                    <div className="absolute right-0 mt-2 w-60 bg-white rounded-none border border-zinc-100 overflow-hidden z-50 py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                      <div className="px-5 py-4 border-b border-zinc-50 mb-2 bg-zinc-50/30">
                         <p className="text-[13px] font-bold tracking-wider text-zinc-400 mb-1">Tài khoản tri thức</p>
