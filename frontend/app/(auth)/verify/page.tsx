              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="appearance-none block w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:outline-none focus:ring-0 focus:border-zinc-200 text-center text-2xl tracking-[0.25em] font-medium text-black uppercase"
                  />
                </div>
              </div>
