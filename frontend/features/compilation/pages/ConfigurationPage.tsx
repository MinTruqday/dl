...
export default function ConfigPage() {
  ...
  return (
    <div className="app-page gap-6">
      <PageHeader title="Cấu hình tài liệu" />
      <div
        ...
        <div className="bg-white p-6 rounded-[var(--radius-panel)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
          ...
          <div className="relative w-full sm:w-[320px]">
            ...
            <select
              ...
              className="w-full h-[48px] pl-12 pr-10 text-[15px] font-medium text-[var(--ink)] focus:outline-none focus:border-[var(--brand)] bg-white rounded-[var(--radius-control)] appearance-none transition-colors cursor-pointer"
            >
              {documents.length === 0 && (
            ...
            <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--ink-muted)] pointer-events-none" />
          </div>
        </div>
        ...
        {selectedDocumentId ? (
          <div className="flex-1 min-h-0 pb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="bg-white border border-[var(--border)] p-6 rounded-[var(--radius-panel)]">
                <div className="flex items-center gap-2 mb-4">
                  <Hash className="w-5 h-5 text-[var(--ink)]" />
                  <p className="text-[13px] font-medium text-[var(--ink-muted)] mb-4">
                    Phân loại & Thẻ
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4 min-h-[32px]">
                  {docTags.map((tag) => (
                    <span
                      key={tag}
                      className="flex items-center gap-1 bg-[var(--surface-quiet)] px-3 py-1.5 text-[13px] font-medium text-[var(--ink)] rounded-[var(--radius-control)] group"
                    >
                      {tag}{" "}
                      <button
                  ...
                  {docTags.length === 0 && (
                    <span className="text-[13px] text-[var(--border-strong)]">
                      Chưa có thẻ nào
                    </span>
                  )}
                </div>
                <div className="relative">
                  <Tag className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[var(--ink-muted)]" />
                  <input
                    type="text"
                    value={newTagInput}
                    ...
                    placeholder=""
                    className="w-full h-[48px] pl-12 pr-4 text-[15px] rounded-[var(--radius-control)] outline-none focus:border-[var(--brand)] bg-[var(--surface-quiet)] focus:bg-white transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="bg-white border border-[var(--border)] p-6 rounded-[var(--radius-panel)]">
                ...
                <div className="relative">
                  <Folder className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[var(--ink-muted)]" />
                  <select
                    ...
                    className="w-full h-[48px] pl-12 pr-10 text-[15px] font-medium rounded-[var(--radius-control)] outline-none bg-[var(--surface-quiet)] focus:bg-white focus:border-[var(--brand)] appearance-none transition-colors cursor-pointer"
                  >
              ...
              <div className="bg-white border border-[var(--border)] p-6 rounded-[var(--radius-panel)]">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className="h-[36px] px-4 bg-[var(--brand)] text-white text-[13px] font-medium rounded-full disabled:opacity-50 transition-colors hover:bg-[var(--brand-hover)]"
                  >
                    {savingDrm ? (
                ...
                <div className="space-y-4 bg-[var(--surface-quiet)] p-4 rounded-[var(--radius-panel)]">
                  <label className="flex items-center justify-between cursor-pointer group">
                    <span className="text-[13px] font-medium text-[var(--ink)]">
                      Chống bôi đen & Copy
                    </span>
                    <div
                      className={`w-[48px] h-[28px] rounded-full flex items-center p-1 transition-colors ${drmCopy ? "bg-[var(--success)] border-[var(--success)]" : "bg-[var(--border)] border-[var(--border-strong)]"}`}
                    >
                      <div
                  ...
                  <label className="flex items-center justify-between cursor-pointer group">
                    ...
                    <div
                      className={`w-[48px] h-[28px] rounded-full flex items-center p-1 transition-colors ${drmSearch ? "bg-[var(--success)] border-[var(--success)]" : "bg-[var(--border)] border-[var(--border-strong)]"}`}
                    >
                      <div
            ...
            <div className="space-y-6">
              <div className="bg-white border border-[var(--border)] p-6 rounded-[var(--radius-panel)] relative overflow-hidden">
                ...
                <p className="text-[13px] text-[var(--ink-muted)] mb-4 relative z-10">
                  Đồng bộ nội dung với hệ thống RAG để AI hỗ trợ độc giả.
                </p>
                <button
                  onClick={handleIngestAI}
                  disabled={isIngesting || !selectedDocumentId}
                  className="w-full h-[48px] bg-[var(--ink)] text-white text-[15px] font-medium flex items-center justify-center gap-2 rounded-full disabled:opacity-50 transition-colors hover:bg-[#333336] relative z-10"
                >
                  {isIngesting ? (
              ...
              <div className="bg-white border border-[var(--border)] p-6 rounded-[var(--radius-panel)]">
                ...
                <div className="flex gap-2 mb-4">
                  <input
                    ...
                    placeholder=""
                    className="flex-1 h-[48px] pl-4 pr-4 text-[15px] rounded-[var(--radius-control)] outline-none focus:border-[var(--brand)] bg-[var(--surface-quiet)] focus:bg-white transition-colors"
                  />
                  <button
                    onClick={handleInviteCollab}
                    disabled={!inviteEmail.trim()}
                    className="h-[48px] px-6 bg-[var(--brand)] text-white text-[15px] font-medium rounded-[var(--radius-control)] disabled:opacity-50 flex items-center gap-2 hover:bg-[var(--brand-hover)] transition-colors"
                  >
                    Mời <Send className="w-4 h-4" />
                  </button>
                </div>
                <div className="bg-[var(--surface-quiet)] rounded-[var(--radius-panel)] p-4 max-h-[160px] overflow-y-auto custom-scrollbar">
                  {loadingCollabs ? (
                      ...
                      {collaborators.map((c: any) => (
                        ...
                        >
                          <div className="flex flex-col">
                            ...
                            <span className="text-[13px] text-[var(--ink-muted)] capitalize">
                              {c.role}
                            </span>
                          </div>
                          <button
                            onClick={() => handleRemoveCollab(c.id)}
                            className="w-8 h-8 flex items-center justify-center text-[var(--ink-muted)] hover:text-[var(--danger)] hover:bg-[#FFEBEB] rounded-full transition-colors"
                          >
              ...
              <div className="bg-[var(--danger)]/10 border-[var(--danger)]/20 p-6 rounded-[var(--radius-panel)]">
                <div className="flex items-center gap-2 mb-2 text-[var(--danger)]">
                  <ArrowRightLeft className="w-5 h-5" />
                  <h3 className="text-[17px] font-medium">Bàn giao tác phẩm</h3>
                </div>
                <p className="text-[13px] text-[var(--danger)] mb-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    placeholder=""
                    className="flex-1 h-[48px] pl-4 pr-4 border-[var(--danger)]/30 text-[15px] rounded-[var(--radius-control)] outline-none focus:border-[var(--danger)] bg-white transition-colors"
                  />
                  <button
                    ...
                    className="h-[48px] px-6 bg-[var(--danger)] text-white text-[15px] font-medium rounded-[var(--radius-control)] disabled:opacity-50 hover:bg-[#E0332A] transition-colors"
                  >
                    Chuyển
                  </button>
                </div>
          ...
          <div className="flex-1 bg-white rounded-[var(--radius-panel)] p-12 flex flex-col items-center justify-center gap-4 text-center">
            <div className="w-16 h-16 bg-[var(--surface-quiet)] border-[var(--border)] flex items-center justify-center rounded-[var(--radius-panel)] mb-2">
              <Settings className="w-8 h-8 text-[var(--border-strong)]" />
            </div>
      ...
      >
        <ModalHeader className="bg-[var(--danger)]/10">
          <ModalTitle className="text-[var(--danger)] flex items-center gap-2">
            <ArrowRightLeft className="w-5 h-5" /> Xác nhận chuyển nhượng
          </ModalTitle>
          <ModalDescription className="text-[var(--danger)] ml-7">
            Hành động nguy hiểm
          </ModalDescription>
        </ModalHeader>
        <ModalContent>
        ...
        <ModalFooter>
          <button
            ...
            className="flex-1 h-[44px] bg-white text-[15px] font-medium text-[var(--ink)] rounded-full hover:bg-[var(--border)] transition-colors"
          >
            Hủy bỏ
          </button>
          <button
            ...
            className="flex-1 h-[44px] bg-[var(--danger)] text-white text-[15px] font-medium rounded-full flex items-center justify-center disabled:opacity-50 hover:bg-[#E0332A] transition-colors gap-2"
          >
