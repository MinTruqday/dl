...
export default function HistoryPage() {
  ...
  return (
    <div className="w-full">
      ...
      {!state.documentId ? (
        <InlineState
          title={state.documents.length ? "Chọn tài liệu để xem phiên bản" : "Chưa có tài liệu"}
          detail={state.documents.length ? undefined : "Tạo tài liệu để bắt đầu lưu phiên bản"}
        />
      ) : (
