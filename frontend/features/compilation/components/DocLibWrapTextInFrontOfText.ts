...
export default class DocLibWrapTextInFrontOfText implements BlockTool {
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-wrap-text-in-front-of-text");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Wrap Text In Front Of Text";
