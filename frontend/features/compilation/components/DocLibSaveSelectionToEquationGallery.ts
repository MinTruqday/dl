...
export default class DocLibSaveSelectionToEquationGallery implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib SaveSelectionToEquationGallery",
  ...
  readonly title = "DocLib SaveSelectionToEquationGallery";
  readonly category = "insert" as const;
  readonly mode = "SaveSelectionToEquationGallery";
  readonly requiresSelection = false;
  readonly microsoftControlId = "SaveSelectionToEquationGallery";
