...
export default class DocLibObjectShadowColorMoreColorsDialog implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ObjectShadowColorMoreColorsDialog",
  ...
  readonly title = "DocLib ObjectShadowColorMoreColorsDialog";
  readonly category = "format" as const;
  readonly mode = "ObjectShadowColorMoreColorsDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ObjectShadowColorMoreColorsDialog";
