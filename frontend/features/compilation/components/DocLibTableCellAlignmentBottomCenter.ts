...
export default class DocLibTableCellAlignmentBottomCenter implements BlockTool {
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-table-cell-alignment-bottom-center");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Table Cell Alignment Bottom Center";
