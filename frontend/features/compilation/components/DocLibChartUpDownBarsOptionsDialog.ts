...
export default class DocLibChartUpDownBarsOptionsDialog implements BlockTool {
  ...
  readonly id = "DocLibChartUpDownBarsOptionsDialog";
  readonly title = "DocLib ChartUpDownBarsOptionsDialog";
  readonly category = "layout" as const;
  readonly mode = "ChartUpDownBarsOptionsDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartUpDownBarsOptionsDialog";
