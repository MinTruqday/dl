...
export default class DocLibWritingAssistanceCheckDocument implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib WritingAssistanceCheckDocument",
  ...
  readonly title = "DocLib WritingAssistanceCheckDocument";
  readonly category = "format" as const;
  readonly mode = "WritingAssistanceCheckDocument";
  readonly requiresSelection = false;
  readonly microsoftControlId = "WritingAssistanceCheckDocument";
