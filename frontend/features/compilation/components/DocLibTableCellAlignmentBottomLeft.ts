...
export default class DocLibTableCellAlignmentBottomLeft implements BlockTool {
  private api: API;
  ...
  static get toolbox() {
    return {
      title: "DocLib Table Cell Alignment Bottom Left",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-table-cell-alignment-bottom-left");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Table Cell Alignment Bottom Left";
