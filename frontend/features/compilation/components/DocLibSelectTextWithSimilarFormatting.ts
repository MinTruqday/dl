...
export default class DocLibSelectTextWithSimilarFormatting implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib SelectTextWithSimilarFormatting",
  ...
  readonly title = "DocLib SelectTextWithSimilarFormatting";
  readonly category = "format" as const;
  readonly mode = "SelectTextWithSimilarFormatting";
  readonly requiresSelection = false;
  readonly microsoftControlId = "SelectTextWithSimilarFormatting";
