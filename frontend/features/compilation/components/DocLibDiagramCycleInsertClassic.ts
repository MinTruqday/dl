...
export default class DocLibDiagramCycleInsertClassic implements BlockTool {
  ...
  readonly id = "DocLibDiagramCycleInsertClassic";
  readonly title = "DocLib DiagramCycleInsertClassic";
  readonly category = "format" as const;
  readonly mode = "DiagramCycleInsertClassic";
  readonly requiresSelection = false;
  readonly microsoftControlId = "DiagramCycleInsertClassic";
