...
export default class DocLibChartPrimaryVerticalGridlinesOptionsDialog implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ChartPrimaryVerticalGridlinesOptionsDialog",
  ...
  readonly title = "DocLib ChartPrimaryVerticalGridlinesOptionsDialog";
  readonly category = "layout" as const;
  readonly mode = "ChartPrimaryVerticalGridlinesOptionsDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartPrimaryVerticalGridlinesOptionsDialog";
