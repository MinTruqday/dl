...
export default class DocLibDictateInMenu implements BlockTool {
  ...
  readonly id = "DocLibDictateInMenu";
  readonly title = "DocLib DictateInMenu";
  readonly category = "format" as const;
  readonly mode = "DictateInMenu";
  readonly requiresSelection = false;
  readonly microsoftControlId = "DictateInMenu";
