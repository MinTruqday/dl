...
export default class DocLibLearningToolsWebViewColumnWidthMedium implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib LearningToolsWebViewColumnWidthMedium",
  ...
  readonly title = "DocLib LearningToolsWebViewColumnWidthMedium";
  readonly category = "table" as const;
  readonly mode = "LearningToolsWebViewColumnWidthMedium";
  readonly requiresSelection = false;
  readonly microsoftControlId = "LearningToolsWebViewColumnWidthMedium";
