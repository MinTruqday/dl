  ...
  render() {
    ...
    if (!document.getElementById("doclib-personality-styles")) {
      ...
      style.innerHTML = `
        ...
        .doclib-personality-name:empty::before { content: 'DocLib Name'; color: #94a3b8; pointer-events: none; }
        .doclib-personality-desc { font-size: 0.9em; color: #64748b; outline: none; }
        .doclib-personality-desc:empty::before { content: 'DocLib Input'; color: #94a3b8; pointer-events: none; }
        .doclib-personality-link { font-size: 0.85em; color: #3b82f6; outline: none; }
        .doclib-personality-link:empty::before { content: 'DocLib URL'; color: #94a3b8; pointer-events: none; }
      `;
