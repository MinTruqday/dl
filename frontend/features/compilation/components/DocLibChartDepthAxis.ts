...
export default class DocLibChartDepthAxis implements BlockTool {
  ...
  readonly id = "DocLibChartDepthAxis";
  readonly title = "DocLib ChartDepthAxis";
  readonly category = "layout" as const;
  readonly mode = "ChartDepthAxis";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartDepthAxis";
