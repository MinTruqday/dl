...
export default class DocLibHyperlinkOpenDefaultSettingMenu implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib HyperlinkOpenDefaultSettingMenu",
  ...
  readonly title = "DocLib HyperlinkOpenDefaultSettingMenu";
  readonly category = "media" as const;
  readonly mode = "HyperlinkOpenDefaultSettingMenu";
  readonly requiresSelection = false;
  readonly microsoftControlId = "HyperlinkOpenDefaultSettingMenu";
