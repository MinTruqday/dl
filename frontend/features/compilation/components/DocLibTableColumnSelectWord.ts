...
export default class DocLibTableColumnSelectWord implements BlockTool {
  ...
  readonly id = "DocLibTableColumnSelectWord";
  readonly title = "DocLib TableColumnSelectWord";
  readonly category = "format" as const;
  readonly mode = "TableColumnSelectWord";
  readonly requiresSelection = false;
  readonly microsoftControlId = "TableColumnSelectWord";
