...
export default class DocLibTextDirectionVertical implements BlockTool {
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-text-direction-vertical");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Text Direction Vertical";
