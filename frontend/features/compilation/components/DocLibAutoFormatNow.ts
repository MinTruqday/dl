...
export default class DocLibAutoFormatNow implements BlockTool {
  ...
  readonly id = "DocLibAutoFormatNow";
  readonly title = "DocLib AutoFormatNow";
  readonly category = "format" as const;
  readonly mode = "AutoFormatNow";
  readonly requiresSelection = false;
  readonly microsoftControlId = "AutoFormatNow";
