...
export default class DocLibWindowSideBySideSynchronousScrolling implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib WindowSideBySideSynchronousScrolling",
  ...
  readonly title = "DocLib WindowSideBySideSynchronousScrolling";
  readonly category = "view" as const;
  readonly mode = "WindowSideBySideSynchronousScrolling";
  readonly requiresSelection = false;
  readonly microsoftControlId = "WindowSideBySideSynchronousScrolling";
