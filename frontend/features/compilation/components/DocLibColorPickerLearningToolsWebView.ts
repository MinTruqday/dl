...
export default class DocLibColorPickerLearningToolsWebView implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ColorPickerLearningToolsWebView",
  ...
  readonly title = "DocLib ColorPickerLearningToolsWebView";
  readonly category = "table" as const;
  readonly mode = "ColorPickerLearningToolsWebView";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ColorPickerLearningToolsWebView";
