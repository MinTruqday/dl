...
export default class DocLibPasteLinkedExcelChartDestinationTheme implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PasteLinkedExcelChartDestinationTheme",
  ...
  readonly title = "DocLib PasteLinkedExcelChartDestinationTheme";
  readonly category = "format" as const;
  readonly mode = "PasteLinkedExcelChartDestinationTheme";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PasteLinkedExcelChartDestinationTheme";
