...
export default class DocLibPictureBrightnessAndContrastGallery implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PictureBrightnessAndContrastGallery",
  ...
  readonly title = "DocLib PictureBrightnessAndContrastGallery";
  readonly category = "media" as const;
  readonly mode = "PictureBrightnessAndContrastGallery";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PictureBrightnessAndContrastGallery";
