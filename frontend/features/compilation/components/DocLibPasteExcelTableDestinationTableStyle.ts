...
export default class DocLibPasteExcelTableDestinationTableStyle implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PasteExcelTableDestinationTableStyle",
  ...
  readonly title = "DocLib PasteExcelTableDestinationTableStyle";
  readonly category = "format" as const;
  readonly mode = "PasteExcelTableDestinationTableStyle";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PasteExcelTableDestinationTableStyle";
