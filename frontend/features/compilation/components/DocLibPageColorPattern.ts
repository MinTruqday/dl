...
export default class DocLibPageColorPattern implements BlockTool {
  ...
  static get toolbox() {
    return {
      title: "DocLib Page Color Pattern",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-page-color-pattern");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data.content;
    this.wrapper.dataset.placeholder = "DocLib Page Color Pattern";
