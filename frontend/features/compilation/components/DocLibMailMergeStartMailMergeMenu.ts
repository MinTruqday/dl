...
export default class DocLibMailMergeStartMailMergeMenu implements BlockTool {
  ...
  readonly id = "DocLibMailMergeStartMailMergeMenu";
  readonly title = "DocLib MailMergeStartMailMergeMenu";
  readonly category = "mailing" as const;
  readonly mode = "MailMergeStartMailMergeMenu";
  readonly requiresSelection = false;
  readonly microsoftControlId = "MailMergeStartMailMergeMenu";
