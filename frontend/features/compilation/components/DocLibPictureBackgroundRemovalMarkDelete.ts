...
export default class DocLibPictureBackgroundRemovalMarkDelete implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PictureBackgroundRemovalMarkDelete",
  ...
  readonly title = "DocLib PictureBackgroundRemovalMarkDelete";
  readonly category = "format" as const;
  readonly mode = "PictureBackgroundRemovalMarkDelete";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PictureBackgroundRemovalMarkDelete";
