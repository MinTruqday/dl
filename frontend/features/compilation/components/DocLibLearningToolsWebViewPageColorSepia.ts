...
export default class DocLibLearningToolsWebViewPageColorSepia implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib LearningToolsWebViewPageColorSepia",
  ...
  readonly title = "DocLib LearningToolsWebViewPageColorSepia";
  readonly category = "table" as const;
  readonly mode = "LearningToolsWebViewPageColorSepia";
  readonly requiresSelection = false;
  readonly microsoftControlId = "LearningToolsWebViewPageColorSepia";
