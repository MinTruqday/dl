...
export default class DocLibMailMergeRecepientsUseExistingList implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib MailMergeRecepientsUseExistingList",
  ...
  readonly title = "DocLib MailMergeRecepientsUseExistingList";
  readonly category = "mailing" as const;
  readonly mode = "MailMergeRecepientsUseExistingList";
  readonly requiresSelection = false;
  readonly microsoftControlId = "MailMergeRecepientsUseExistingList";
