...
export default class DocLibBibliographyManageSources implements BlockTool {
  ...
  readonly id = "DocLibBibliographyManageSources";
  readonly title = "DocLib BibliographyManageSources";
  readonly category = "reference" as const;
  readonly mode = "BibliographyManageSources";
  readonly requiresSelection = false;
  readonly microsoftControlId = "BibliographyManageSources";
