...
export default class DocLibLayoutOptionsDialog implements BlockTool {
  ...
  readonly id = "DocLibLayoutOptionsDialog";
  readonly title = "DocLib LayoutOptionsDialog";
  readonly category = "format" as const;
  readonly mode = "LayoutOptionsDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "LayoutOptionsDialog";
