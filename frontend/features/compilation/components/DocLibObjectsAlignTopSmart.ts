...
export default class DocLibObjectsAlignTopSmart implements BlockTool {
  ...
  readonly id = "DocLibObjectsAlignTopSmart";
  readonly title = "DocLib ObjectsAlignTopSmart";
  readonly category = "layout" as const;
  readonly mode = "ObjectsAlignTopSmart";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ObjectsAlignTopSmart";
