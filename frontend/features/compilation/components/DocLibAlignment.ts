...
export default class DocLibAlignmentTune implements BlockTune {
  ...
  private alignments = [
    { name: "left", icon: IconAlignLeft, title: "Căn trái" },
    { name: "center", icon: IconAlignCenter, title: "Căn giữa" },
    { name: "right", icon: IconAlignRight, title: "Căn phải" },
    { name: "justify", icon: IconAlignJustify, title: "Căn đều" },
  ];
