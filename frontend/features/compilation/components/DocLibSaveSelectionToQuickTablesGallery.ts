...
export default class DocLibSaveSelectionToQuickTablesGallery implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib SaveSelectionToQuickTablesGallery",
  ...
  readonly title = "DocLib SaveSelectionToQuickTablesGallery";
  readonly category = "table" as const;
  readonly mode = "SaveSelectionToQuickTablesGallery";
  readonly requiresSelection = false;
  readonly microsoftControlId = "SaveSelectionToQuickTablesGallery";
