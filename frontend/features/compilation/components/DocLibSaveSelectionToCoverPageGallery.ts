...
export default class DocLibSaveSelectionToCoverPageGallery implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib SaveSelectionToCoverPageGallery",
  ...
  readonly title = "DocLib SaveSelectionToCoverPageGallery";
  readonly category = "insert" as const;
  readonly mode = "SaveSelectionToCoverPageGallery";
  readonly requiresSelection = false;
  readonly microsoftControlId = "SaveSelectionToCoverPageGallery";
