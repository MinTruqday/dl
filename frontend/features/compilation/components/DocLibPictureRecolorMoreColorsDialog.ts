...
export default class DocLibPictureRecolorMoreColorsDialog implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PictureRecolorMoreColorsDialog",
  ...
  readonly title = "DocLib PictureRecolorMoreColorsDialog";
  readonly category = "media" as const;
  readonly mode = "PictureRecolorMoreColorsDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PictureRecolorMoreColorsDialog";
