...
export default class DocLibZoom100 implements BlockTool {
  ...
  readonly id = "DocLibZoom100";
  readonly title = "DocLib Zoom100";
  readonly category = "format" as const;
  readonly mode = "Zoom100";
  readonly requiresSelection = false;
  readonly microsoftControlId = "Zoom100";
