...
export default class DocLibPasteExcelChartSourceFormatting implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PasteExcelChartSourceFormatting",
  ...
  readonly title = "DocLib PasteExcelChartSourceFormatting";
  readonly category = "format" as const;
  readonly mode = "PasteExcelChartSourceFormatting";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PasteExcelChartSourceFormatting";
