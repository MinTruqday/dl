...
export default class DocLibActiveXComboBox implements BlockTool {
  ...
  static get toolbox() {
    return {
      title: "DocLib Active X Combo Box",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-active-x-combo-box");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Active X Combo Box";
