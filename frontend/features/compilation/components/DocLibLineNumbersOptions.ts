...
export default class DocLibLineNumbersOptions implements BlockTool {
  private api: API;
  ...
  static get toolbox() {
    return {
      title: "DocLib Line Numbers Options",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-line-numbers-options");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Line Numbers Options";
