...
export default class DocLibDrawing1ColorPickerFillWordArt implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib Drawing1ColorPickerFillWordArt",
  ...
  readonly title = "DocLib Drawing1ColorPickerFillWordArt";
  readonly category = "format" as const;
  readonly mode = "Drawing1ColorPickerFillWordArt";
  readonly requiresSelection = false;
  readonly microsoftControlId = "Drawing1ColorPickerFillWordArt";
