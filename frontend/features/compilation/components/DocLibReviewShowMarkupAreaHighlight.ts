...
export default class DocLibReviewShowMarkupAreaHighlight implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ReviewShowMarkupAreaHighlight",
  ...
  readonly title = "DocLib ReviewShowMarkupAreaHighlight";
  readonly category = "format" as const;
  readonly mode = "ReviewShowMarkupAreaHighlight";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ReviewShowMarkupAreaHighlight";
