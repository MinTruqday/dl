...
export default class DocLibReviewChangeUserName implements BlockTool {
  ...
  readonly id = "DocLibReviewChangeUserName";
  readonly title = "DocLib ReviewChangeUserName";
  readonly category = "format" as const;
  readonly mode = "ReviewChangeUserName";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ReviewChangeUserName";
