...
export default class DocLibOrganizationChartInsertAssistant implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib OrganizationChartInsertAssistant",
  ...
  readonly title = "DocLib OrganizationChartInsertAssistant";
  readonly category = "media" as const;
  readonly mode = "OrganizationChartInsertAssistant";
  readonly requiresSelection = false;
  readonly microsoftControlId = "OrganizationChartInsertAssistant";
