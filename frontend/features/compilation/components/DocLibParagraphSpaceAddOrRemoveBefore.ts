...
export default class DocLibParagraphSpaceAddOrRemoveBefore implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ParagraphSpaceAddOrRemoveBefore",
  ...
  readonly title = "DocLib ParagraphSpaceAddOrRemoveBefore";
  readonly category = "format" as const;
  readonly mode = "ParagraphSpaceAddOrRemoveBefore";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ParagraphSpaceAddOrRemoveBefore";
