...
export default class DocLibReturnAddressFormatFontDialog implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ReturnAddressFormatFontDialog",
  ...
  readonly title = "DocLib ReturnAddressFormatFontDialog";
  readonly category = "format" as const;
  readonly mode = "ReturnAddressFormatFontDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ReturnAddressFormatFontDialog";
