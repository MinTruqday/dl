...
export default class DocLibPageColorTexture implements BlockTool {
  ...
  static get toolbox() {
    return {
      title: "DocLib Page Color Texture",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-page-color-texture");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Page Color Texture";
