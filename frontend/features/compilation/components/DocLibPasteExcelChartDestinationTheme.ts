...
export default class DocLibPasteExcelChartDestinationTheme implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib PasteExcelChartDestinationTheme",
  ...
  readonly title = "DocLib PasteExcelChartDestinationTheme";
  readonly category = "format" as const;
  readonly mode = "PasteExcelChartDestinationTheme";
  readonly requiresSelection = false;
  readonly microsoftControlId = "PasteExcelChartDestinationTheme";
