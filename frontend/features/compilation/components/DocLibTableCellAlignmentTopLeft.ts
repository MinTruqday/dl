...
export default class DocLibTableCellAlignmentTopLeft implements BlockTool {
  static readonly feature = {
    ...
    title: "Table Cell Alignment Top Left",
  ...
  readonly id = "DocLibTableCellAlignmentTopLeft";
  readonly title = "Table Cell Alignment Top Left";
  readonly category = "table" as const;
  readonly mode = "TableCellAlignmentTopLeft";
