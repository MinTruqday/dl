...
export default class DocLibTextSmallCaps implements BlockTool {
  ...
  readonly id = "DocLibTextSmallCaps";
  readonly title = "DocLib TextSmallCaps";
  readonly category = "format" as const;
  readonly mode = "TextSmallCaps";
  readonly requiresSelection = false;
  readonly microsoftControlId = "TextSmallCaps";
