...
export default class DocLibChartPrimaryHorizontalGridlines implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ChartPrimaryHorizontalGridlines",
  ...
  readonly title = "DocLib ChartPrimaryHorizontalGridlines";
  readonly category = "layout" as const;
  readonly mode = "ChartPrimaryHorizontalGridlines";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartPrimaryHorizontalGridlines";
