...
export default class DocLibChartMajorGridlinesAdd implements BlockTool {
  ...
  readonly id = "DocLibChartMajorGridlinesAdd";
  readonly title = "DocLib ChartMajorGridlinesAdd";
  readonly category = "media" as const;
  readonly mode = "ChartMajorGridlinesAdd";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartMajorGridlinesAdd";
