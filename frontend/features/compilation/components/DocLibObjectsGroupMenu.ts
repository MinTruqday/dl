...
export default class DocLibObjectsGroupMenu implements BlockTool {
  ...
  readonly id = "DocLibObjectsGroupMenu";
  readonly title = "DocLib ObjectsGroupMenu";
  readonly category = "layout" as const;
  readonly mode = "ObjectsGroupMenu";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ObjectsGroupMenu";
