...
export default class DocLibRepeatHeaderRows implements BlockTool {
  private api: API;
  ...
  static get toolbox() {
    return {
      title: "DocLib Repeat Header Rows",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-repeat-header-rows");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "Doc Lib Repeat Header Rows";
