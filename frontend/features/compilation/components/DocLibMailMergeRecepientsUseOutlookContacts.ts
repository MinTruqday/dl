...
export default class DocLibMailMergeRecepientsUseOutlookContacts implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib MailMergeRecepientsUseOutlookContacts",
  ...
  readonly title = "DocLib MailMergeRecepientsUseOutlookContacts";
  readonly category = "mailing" as const;
  readonly mode = "MailMergeRecepientsUseOutlookContacts";
  readonly requiresSelection = false;
  readonly microsoftControlId = "MailMergeRecepientsUseOutlookContacts";
