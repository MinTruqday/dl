...
export default class DocLibSimpleMarkup implements BlockTool {
  private api: API;
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-simple-markup");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "Doc Lib Simple Markup";
