...
export default class DocLibOpenOptionsWordCustomizeRibbon implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib OpenOptionsWordCustomizeRibbon",
  ...
  readonly title = "DocLib OpenOptionsWordCustomizeRibbon";
  readonly category = "format" as const;
  readonly mode = "OpenOptionsWordCustomizeRibbon";
  readonly requiresSelection = false;
  readonly microsoftControlId = "OpenOptionsWordCustomizeRibbon";
