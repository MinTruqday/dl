...
export default class DocLibReadingViewAllowMultiplePages implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ReadingViewAllowMultiplePages",
  ...
  readonly title = "DocLib ReadingViewAllowMultiplePages";
  readonly category = "format" as const;
  readonly mode = "ReadingViewAllowMultiplePages";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ReadingViewAllowMultiplePages";
