...
export default class DocLibWrapTextEditWrapPoints implements BlockTool {
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-wrap-text-edit-wrap-points");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Wrap Text Edit Wrap Points";
