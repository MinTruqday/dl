...
export default class DocLibLearningToolsPageColorMoreColors implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib LearningToolsPageColorMoreColors",
  ...
  readonly title = "DocLib LearningToolsPageColorMoreColors";
  readonly category = "table" as const;
  readonly mode = "LearningToolsPageColorMoreColors";
  readonly requiresSelection = false;
  readonly microsoftControlId = "LearningToolsPageColorMoreColors";
