...
export default class DocLibChartSecondaryHorizontalGridlinesOptionsDialog implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ChartSecondaryHorizontalGridlinesOptionsDialog",
  ...
  readonly title = "DocLib ChartSecondaryHorizontalGridlinesOptionsDialog";
  readonly category = "layout" as const;
  readonly mode = "ChartSecondaryHorizontalGridlinesOptionsDialog";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartSecondaryHorizontalGridlinesOptionsDialog";
