...
export default class DocLibActiveXCommandButton implements BlockTool {
  ...
  static get toolbox() {
    return {
      title: "DocLib Active X Command Button",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-active-x-command-button");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "DocLib Active X Command Button";
