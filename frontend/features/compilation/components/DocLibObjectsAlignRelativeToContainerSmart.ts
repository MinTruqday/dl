...
export default class DocLibObjectsAlignRelativeToContainerSmart implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ObjectsAlignRelativeToContainerSmart",
  ...
  readonly title = "DocLib ObjectsAlignRelativeToContainerSmart";
  readonly category = "layout" as const;
  readonly mode = "ObjectsAlignRelativeToContainerSmart";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ObjectsAlignRelativeToContainerSmart";
