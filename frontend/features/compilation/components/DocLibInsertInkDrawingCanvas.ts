...
export default class DocLibInsertInkDrawingCanvas implements BlockTool {
  ...
  readonly id = "DocLibInsertInkDrawingCanvas";
  readonly title = "DocLib InsertInkDrawingCanvas";
  readonly category = "insert" as const;
  readonly mode = "InsertInkDrawingCanvas";
  readonly requiresSelection = false;
  readonly microsoftControlId = "InsertInkDrawingCanvas";
