...
export default class DocLibInsertBuildingBlocksEquationsGallery implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib InsertBuildingBlocksEquationsGallery",
  ...
  readonly title = "DocLib InsertBuildingBlocksEquationsGallery";
  readonly category = "insert" as const;
  readonly mode = "InsertBuildingBlocksEquationsGallery";
  readonly requiresSelection = false;
  readonly microsoftControlId = "InsertBuildingBlocksEquationsGallery";
