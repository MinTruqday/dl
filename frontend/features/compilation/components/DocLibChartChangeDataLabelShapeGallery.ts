...
export default class DocLibChartChangeDataLabelShapeGallery implements BlockTool {
  static readonly feature = {
    ...
    title: "DocLib ChartChangeDataLabelShapeGallery",
  ...
  readonly title = "DocLib ChartChangeDataLabelShapeGallery";
  readonly category = "media" as const;
  readonly mode = "ChartChangeDataLabelShapeGallery";
  readonly requiresSelection = false;
  readonly microsoftControlId = "ChartChangeDataLabelShapeGallery";
