...
export default class DocLibParagraphSpacingSet implements BlockTool {
  private api: API;
  ...
  static get toolbox() {
    return {
      title: "DocLib Paragraph Spacing Set",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-paragraph-spacing-set");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "Doc Lib Paragraph Spacing Set";
