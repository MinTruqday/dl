...
export default class DocLibFontSubstitution implements BlockTool {
  ...
  readonly id = "DocLibFontSubstitution";
  readonly title = "DocLib FontSubstitution";
  readonly category = "format" as const;
  readonly mode = "FontSubstitution";
  readonly requiresSelection = false;
  readonly microsoftControlId = "FontSubstitution";
