...
export default class DocLibPictureCorrections implements BlockTool {
  ...
  static get toolbox() {
    return {
      title: "DocLib Picture Corrections",
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-picture-corrections");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data?.content;
    this.wrapper.dataset.placeholder = "Doc Lib Picture Corrections";
