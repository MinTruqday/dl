...
export default class DocLibOpenTypeStandardAndContextual implements BlockTool {
  ...
  render() {
    ...
    this.wrapper.classList.add(this.api.styles.block, "doclib-doc-lib-open-type-standard-and-contextual");
    this.wrapper.contentEditable = "true";
    this.wrapper.innerHTML = this.data.content;
    this.wrapper.dataset.placeholder = "DocLib Open Type Standard And Contextual";
