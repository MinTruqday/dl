...
export default class DocLibPageNumberCurrentPosition implements BlockTool {
  static readonly feature = {
    ...
    title: "Page Number Current Position",
  ...
  readonly id = "DocLibPageNumberCurrentPosition";
  readonly title = "Page Number Current Position";
  readonly category = "layout" as const;
  readonly mode = "PageNumberCurrentPosition";
