...
export default function ForgotPasswordPage() {
    ...
    return (<AuthFrame title="Khôi phục mật khẩu" description="Nhập email để nhận mã xác thực" footer={<div className="flex flex-wrap gap-x-4 gap-y-2">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        <AuthField id="recovery-email" name="email" label="Email" type="email" autoComplete="email" required value={email} onChange={(event) => setEmail(event.target.value)}/>
