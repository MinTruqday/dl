...
import { passkeyRegisterBeginAPI, passkeyRegisterFinishAPI, } from "@/features/authentication/services/session.service";
import { b64urlToBuffer, bufferToB64url } from "@/features/authentication/lib/webauthn";
export function usePasskeySetup(email, onSuccess) {
        ...
        try {
            ...
            const result = await navigator.credentials.create({
                publicKey: {
                    ...
                    rp: begin.rp,
                    user: Object.assign(Object.assign({}, begin.user), { id: b64urlToBuffer(begin.user.id) }),
            ...
            if (!result)
                throw new Error("Không nhận được thông tin passkey");
