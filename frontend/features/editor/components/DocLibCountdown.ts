...
export default class DocLibCountdown implements BlockTool {
  ...
  private buildUI() {
      ...
      this.timerId = setInterval(() => this.updateTimer(dBox.num, hBox.num, mBox.num, sBox.num), 1000);
  }
  
  private updateTimer(d: HTMLElement, h: HTMLElement, m: HTMLElement, s: HTMLElement) {
