...
export default class DocLibList implements BlockTool {
  ...
  renderSettings() {
      ...
      orderedBtn.innerHTML = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" y1="6" x2="21" y2="6"></line><line x1="10" y1="12" x2="21" y2="12"></line><line x1="10" y1="18" x2="21" y2="18"></line><path d="M4 6h1v4"></path><path d="M4 10h2"></path><path d="M6 18H4c0-1 2-2 2-3s-1-1.5-2-1"></path></svg>';
      
      if (this.data.style === 'unordered') unorderedBtn.classList.add(this.api.styles.settingsButtonActive);
      if (this.data.style === 'ordered') orderedBtn.classList.add(this.api.styles.settingsButtonActive);
  ...
  private buildList() {
      ...
      this.listElement = document.createElement(this.data.style === 'ordered' ? 'ol' : 'ul');
      ...
      this.listElement.addEventListener('input', () => {
          this.data.items = Array.from(this.listElement!.querySelectorAll('li')).map(li => li.innerHTML);
      });
