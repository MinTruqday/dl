...
export async function login(email: string, password: string) {
  ...
  const res = await fetch(`${API_URL}/xac-thuc/login`, {
    method: "POST",
    headers: {
...
export async function register(
  ...
  const res = await fetch(`${API_URL}/xac-thuc/register`, {
    method: "POST",
    headers: {
...
export async function getUserMe() {
  ...
  userMePromise = (async () => {
    try {
      const res = await fetch(`${API_URL}/xac-thuc/personal`, {
        method: "GET",
        headers: {
...
export const passkeyLoginBeginAPI = async (email: string): Promise<any> => {
  const res = await fetch(`${API_URL}/xac-thuc/passkey/login/start`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ email }),
  });
...
export const passkeyRegisterBeginAPI = async (email: string): Promise<any> => {
  const res = await fetch(`${API_URL}/xac-thuc/passkey/register/start`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ email }),
  });
...
export const getGoogleLoginUrlAPI = async (): Promise<string> => {
  const res = await fetch(`${API_URL}/xac-thuc/google/login`);
  const data = await res.json();
