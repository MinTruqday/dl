  ...
  return (
    ...
    >
      ...
      {can("testanalysis.run_ai") && (
        <Panel title="Tạo ứng viên điều kiện kiểm thử từ Requirement">
          <div className="space-y-4 p-5">
                ...
                try {
                  ...
                  setAiResult(
                    await testingApi.runTestAnalysisAi(project._id, {
                      ...
                      instruction:
                        "Tạo các điều kiện kiểm thử dương, âm, biên, trạng thái, quyền, tích hợp, dữ liệu lỗi và phi chức năng từ Requirement. Chỉ trả ứng viên điều kiện; không đánh giá lại chất lượng Requirement.",
            ...
            >
              {aiRunning ? "AI đang tạo ứng viên" : "Tạo ứng viên điều kiện"}
            </button>
        ...
        <TestConditionEditor
          initialValue={
            selected
              ? {
                  ...selected,
                  // AI candidates carry a plain `description`; saved conditions
                  // carry `description_doc`. Prefer the saved document only
                  // when it has text so the candidate description is retained.
