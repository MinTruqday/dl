  ...
  return (
    <DataTable
      ...
      columns={[
        ...
        { key: "snapshot_hash", label: "Mã snapshot", render: (item) => item.snapshot_hash?.slice(0, 16) || "Chưa chốt" },
        { key: "updated_at", label: "Cập nhật", render: (item) => new Date(item.updated_at).toLocaleString("vi-VN") },
