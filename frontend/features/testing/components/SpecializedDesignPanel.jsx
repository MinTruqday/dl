      ...
      <div className="grid gap-5 p-5 xl:grid-cols-2">
        ...
        {canGeneratePerformance && (
          <div className="space-y-3">
            ...
            <form className="space-y-5" onSubmit={generatePerformance}>
              <div className="grid gap-4 md:grid-cols-2">
                <label className="field-label">
                  ...
                  <input
                    ...
                    required
                    placeholder="Ví dụ: Hiệu năng thanh toán Sprint 1"
                    value={performance.name}
                    onChange={(event) =>
                      setPerformance({ ...performance, name: event.target.value })
                    }
                  />
                </label>
                <label className="field-label">
                  ...
                  <textarea
                    ...
                    placeholder="Nêu mục tiêu đo hiệu năng cần đạt"
