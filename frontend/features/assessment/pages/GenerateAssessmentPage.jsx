...
export default function GenerateAssessmentPage() {
    ...
    useEffect(() => { listAssessmentDrafts().then((values) => { setDrafts(values); if (requestedId || values[0])
        setDraftId(requestedId || values[0]._id); }); }, [requestedId]);
