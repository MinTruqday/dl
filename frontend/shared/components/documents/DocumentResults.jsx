...
export default function DocumentResults({
  ...
  if (!documents.length) return <EmptyState text={emptyTitle} description={emptyDescription} />;
  return (
      ...
      {documents.map((document, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <div className="relative hidden h-[72px] w-14 overflow-hidden rounded-control bg-surface-quiet sm:block">
                {cover ? (
                  <Image
                    src={cover}
                    alt=""
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 truncate text-[13px] text-ink-muted">{author}</p>
                ...
                <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-[12px] text-ink-faint sm:hidden">
                  ...
                  <span>
                    {Number(document.views_count ?? document.views ?? 0).toLocaleString("vi-VN")}{" "}
                    lượt xem
                  </span>
                </div>
              </div>
              <div className="hidden text-right text-[12px] text-ink-muted sm:block">
                ...
                <p className="mt-1">
                  {Number(document.views_count ?? document.views ?? 0).toLocaleString("vi-VN")} lượt
                  xem
                </p>
              </div>
            </Link>
